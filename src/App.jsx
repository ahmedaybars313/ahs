...
const P = {
  ...
  p6:`Zeynep ve Can ikiz kardeşti. İkisi de okulda başarılıydı. Zeynep müziği çok severdi; her gün keman çalışırdı. Can ise fen bilimlerine düşkündü, evde küçük deneyler yapardı. Anneleri onlara "Herkesin farklı bir yeteneği vardır." derdi. Zeynep sabah erkenden kalkar, derslere tam hazır gelirdi. Can ise geceleri kitap okumayı tercih ederdi. Her ne kadar çalışma stilleri farklı olsa da her ikisi de ödevlerini zamanında yaparlardı.`
};
...
{id:"e001",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:1,type:"mc",
 question:'"Sit down" ne anlama gelir?',
 options:["A) Ayağa kalk","B) Otur","C) Dışarı çık","D) Kitabı aç"],
 correct:1,wrongFeedback:'"Sit down" = otur. "Stand up" = ayağa kalk.',
 hint:"Sit = oturmak. Down = aşağı.",
 simplified:{question:"Okulda öğretmen sana 'Sit down!' dedi. Ne yaparsın?",options:["A) Ayağa kalkarsın","B) Otursun"],correct:1,hint:"Sit down = otur!"}},

{id:"e002",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:1,type:"mc",
 question:'"Open your book" ne anlama gelir?',
 options:["A) Kitabını kapat","B) Defterini aç","C) Kitabını aç","D) Çantanı aç"],
 correct:2,wrongFeedback:'"Open" = aç. "Book" = kitap. Open your book = kitabını aç.',
 hint:"Open = aç. Book = kitap.",
 simplified:{question:'"Book" ne demek?',options:["A) Defter","B) Kitap","C) Kalem","D) Çanta"],correct:1,hint:"Book = kitap!"}},

{id:"e003",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:1,type:"mc",
 question:'"Be quiet!" ne anlama gelir?',
 options:["A) Hızlı ol","B) Sessiz ol","C) Dikkatli ol","D) Hazır ol"],
 correct:1,wrongFeedback:'"Quiet" = sessiz. "Be quiet!" = Sessiz ol!',
 hint:"Quiet = sessiz, gürültüsüz.",
 simplified:{question:"Öğretmen sınıfta 'Be quiet!' dedi. Ne istiyor?",options:["A) Sessizlik","B) Hız","C) Dikkat","D) Hazırlık"],correct:0,hint:"Quiet = sessiz!"}},

{id:"e004",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:1,type:"mc",
 question:'"Raise your hand" ne anlama gelir?',
 options:["A) Elini yıka","B) Elini indir","C) Elini kaldır","D) Elini uzat"],
 correct:2,wrongFeedback:'"Raise" = kaldır. "Hand" = el. Raise your hand = elini kaldır.',
 hint:"Raise = kaldır. Hand = el.",
 simplified:{question:'"Hand" ne demek?',options:["A) Ayak","B) El","C) Baş","D) Kol"],correct:1,hint:"Hand = el!"}},

{id:"e005",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:2,type:"mc",
 question:'Öğrenci sınıfa girmek istiyor. Ne der?\n"May I ___?"',
 options:["A) come in","B) go out","C) sit down","D) stand up"],
 correct:0,wrongFeedback:'"May I come in?" = İçeri girebilir miyim? Sınıfa girmek için kullanılır.',
 hint:"İçeri girmek = come in.",
 simplified:{question:'"Come in" ne demek?',options:["A) Dışarı çık","B) İçeri gel / gir","C) Otur","D) Dur"],correct:1,hint:"Come in = içeri gir!"}},

{id:"e006",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:2,type:"mc",
 question:'Aşağıdaki komutlardan hangisi "Tekrar et" anlamına gelir?',
 options:["A) Listen","B) Write","C) Repeat","D) Read"],
 correct:2,wrongFeedback:'"Repeat" = tekrar et. Listen=dinle, Write=yaz, Read=oku.',
 hint:"Repeat = tekrar etmek.",
 simplified:{question:'"Repeat" ne demek?',options:["A) Dinle","B) Yaz","C) Tekrar et","D) Oku"],correct:2,hint:"Repeat = tekrar et!"}},

{id:"e007",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:2,type:"mc",
 question:'Doğru eşleştirmeyi bul:\n"Close your book" →',
 options:["A) Kitabını aç","B) Kitabını kapat","C) Kitabını oku","D) Kitabını getir"],
 correct:1,wrongFeedback:'"Close" = kapat. Zıttı "Open" = aç.',
 hint:"Close = kapat. Open = aç. Zıt anlamlılar!",
 simplified:{question:'"Close" ne demek?',options:["A) Aç","B) Kapat","C) Oku","D) Getir"],correct:1,hint:"Close = kapat!"}},

{id:"e008",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:3,type:"mc",
 question:'Sınıfta hangi davranış doğrudur?\nTeacher: "Listen carefully!"\nAhmet: ___',
 options:["A) Konuşmaya devam eder.","B) Sessizce dinler.","C) Kitabını kapatır.","D) Dışarı çıkar."],
 correct:1,wrongFeedback:'"Listen carefully" = Dikkatlice dinle. Doğru davranış: sessizce dinlemek.',
 hint:"Listen = dinle. Carefully = dikkatlice.",
 simplified:{question:'"Listen" ne demek?',options:["A) Konuş","B) Dinle","C) Yaz","D) Oku"],correct:1,hint:"Listen = dinle!"}},

{id:"e009",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:2,type:"mc",
 question:'Boşluğu doldurun:\n"___ your pencil and write your name."',
 options:["A) Close","B) Sit","C) Take","D) Listen"],
 correct:2,wrongFeedback:'"Take your pencil" = kalemi al. Sonra "write your name" = adını yaz.',
 hint:"Kalemini almak = take your pencil.",
 simplified:{question:'"Take" ne demek?',options:["A) Bırak","B) Al","C) Ver","D) Kır"],correct:1,hint:"Take = al!"}},

{id:"e010",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:3,type:"mc",
 question:'Kısa diyalogu tamamla:\nTeacher: "Stand up, please."\nStudent: ___ (doğru tepki)',
 options:["A) Oturur.","B) Ayağa kalkar.","C) Dışarı çıkar.","D) Kitabını açar."],
 correct:1,wrongFeedback:'"Stand up" = ayağa kalk. Öğrencinin doğru tepkisi ayağa kalkmaktır.',
 hint:"Stand up = ayağa kalk. Stand = durmak/kalkmak.",
 simplified:{question:'"Stand up" ne demek?',options:["A) Otur","B) Ayağa kalk","C) Yürü","D) Dur"],correct:1,hint:"Stand up = ayağa kalk!"}},

// ══ UNIT 2: NATIONALITY ══
{id:"e011",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:1,type:"mc",
 question:'"Turkish" ne anlama gelir?',
 options:["A) İngiliz","B) Türk / Türkçe","C) Alman","D) Fransız"],
 correct:1,wrongFeedback:'"Turkish" = Türk veya Türkçe. Turkey = Türkiye.',
 hint:"Turkey → Turkish. Ülke adından milliyet yapılır.",
 simplified:{question:"Türkiye'nin İngilizce adı nedir?",options:["A) German","B) Turkey","C) France","D) Japan"],correct:1,hint:"Türkiye = Turkey!"}},

{id:"e012",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:1,type:"mc",
 question:'"Where are you from?" sorusunun Türkçe anlamı nedir?',
 options:["A) Kaç yaşındasın?","B) Nerelisin?","C) Adın ne?","D) Nasılsın?"],
 correct:1,wrongFeedback:'"Where are you from?" = Nerelisin? / Nereden geliyorsun?',
 hint:"Where = nere. From = -den/-dan.",
 simplified:{question:'"Where" ne demek?',options:["A) Ne zaman","B) Nerede/nereye","C) Neden","D) Kim"],correct:1,hint:"Where = nere!"}},

{id:"e013",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:1,type:"mc",
 question:'Eşleştirmeyi tamamla:\nEngland → ___',
 options:["A) French","B) German","C) English","D) Spanish"],
 correct:2,wrongFeedback:"England (İngiltere) → English (İngiliz). France→French, Germany→German, Spain→Spanish.",
 hint:"England → İngiltere → English → İngiliz.",
 simplified:{question:"İngiltere'nin İngilizce adı nedir?",options:["A) France","B) Germany","C) England","D) Spain"],correct:2,hint:"İngiltere = England!"}},

{id:"e014",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:1,type:"mc",
 question:'Eşleştirmeyi tamamla:\nFrance → ___',
 options:["A) English","B) French","C) German","D) Italian"],
 correct:1,wrongFeedback:"France (Fransa) → French (Fransız).",
 hint:"France → French. Fransa → Fransız.",
 simplified:{question:"Fransa'nın İngilizce adı nedir?",options:["A) Germany","B) England","C) France","D) Italy"],correct:2,hint:"Fransa = France!"}},

{id:"e015",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:2,type:"mc",
 question:'Diyalogu tamamla:\nAli: "Where are you from?"\nSelin: "___ from Turkey. I am Turkish."',
 options:["A) He is","B) She is","C) I am","D) They are"],
 correct:2,wrongFeedback:'"I am from Turkey" = Ben Türkiye\'denliyim. Birinci tekil şahıs = I am.',
 hint:"Ben = I. I am = Benim.",
 simplified:{question:'"I am" ne demek?',options:["A) O","B) Ben","C) Biz","D) Siz"],correct:1,hint:"I = ben → I am = benim!"}},

{id:"e016",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:2,type:"mc",
 question:'Boşluğu doldurun:\nMaria is from Italy. She is ___.',
 options:["A) French","B) Spanish","C) Italian","D) German"],
 correct:2,wrongFeedback:"Italy (İtalya) → Italian (İtalyan). Maria İtalya'dan, yani İtalyan.",
 hint:"Italy → Italian. Ülke adına son ek gelir.",
 simplified:{question:"İtalya'nın İngilizce adı nedir?",options:["A) France","B) Spain","C) Italy","D) Germany"],correct:2,hint:"İtalya = Italy → Italian!"}},

{id:"e017",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:2,type:"mc",
 question:'Okuma:\n"Hi! My name is Kenji. I am from Japan. I am Japanese."\n\nKenji\'s nationality is ___.',
 options:["A) Chinese","B) Korean","C) Japanese","D) Turkish"],
 correct:2,wrongFeedback:"Metinde 'I am Japanese' yazıyor. Kenji Japonya'dan → Japanese (Japon).",
 hint:"Japan → Japanese. Metinde direkt yazıyor!",
 simplified:{question:"Japonya'nın İngilizce adı nedir?",options:["A) China","B) Korea","C) Japan","D) Turkey"],correct:2,hint:"Japonya = Japan → Japanese!"}},

{id:"e018",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:3,type:"mc",
 question:'Doğru cümleyi bul:\nHans is from Germany.',
 options:["A) Hans is French.","B) Hans is German.","C) Hans is Spanish.","D) Hans is Italian."],
 correct:1,wrongFeedback:"Germany (Almanya) → German (Alman). Hans Almanya'dan, yani German.",
 hint:"Germany → German. Almanya → Alman.",
 simplified:{question:"Almanya'nın İngilizce adı nedir?",options:["A) France","B) Spain","C) Germany","D) Italy"],correct:2,hint:"Almanya = Germany → German!"}},

{id:"e019",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:3,type:"mc",
 question:'Hangisi YANLIŞ eşleştirmedir?\nÜlke → Milliyet',
 options:["A) Turkey → Turkish","B) France → French","C) Spain → Spanishly","D) Japan → Japanese"],
 correct:2,wrongFeedback:'"Spanishly" diye bir kelime yoktur. Spain → Spanish (İspanyol). A, B, D doğru.',
 hint:"Spanish doğru, 'Spanishly' yanlış ek almış.",
 simplified:{question:"İspanya'nın İngilizce adı nedir?",options:["A) Italy","B) Portugal","C) Spain","D) France"],correct:2,hint:"İspanya = Spain → Spanish!"}},

{id:"e020",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:3,type:"mc",
 question:'Diyalogu tamamla:\nTeacher: "Where is Pedro from?"\nStudent: "He is from Spain. He is ___."',
 options:["A) Italian","B) French","C) Spanish","D) German"],
 correct:2,wrongFeedback:"Spain → Spanish. Pedro İspanya'dan → Spanish.",
 hint:"Spain → Spanish. Üçüncü tekil = He is Spanish.",
 simplified:{question:"Spain'den gelen biri hangi milliyettedir?",options:["A) French","B) Italian","C) Spanish","D) German"],correct:2,hint:"Spain → Spanish!"}},

// ══ UNIT 3: CARTOON CHARACTERS (have/has, can/can't) ══
{id:"e021",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:1,type:"mc",
 question:'"He has long hair." Bu cümlenin Türkçe anlamı nedir?',
 options:["A) Onun uzun saçları var.","B) O uzun boyludur.","C) Onun uzun bir arabası var.","D) O uzun süre uyudu."],
 correct:0,wrongFeedback:'"Has" = var (üçüncü tekil şahıs). "Long hair" = uzun saç. He has long hair = Onun uzun saçı var.',
 hint:"Has = var (he/she/it için). Hair = saç.",
 simplified:{question:'"Hair" ne demek?',options:["A) El","B) Göz","C) Saç","D) Ayak"],correct:2,hint:"Hair = saç!"}},

{id:"e022",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:1,type:"mc",
 question:'"Can" fiilinin Türkçe anlamı nedir?',
 options:["A) Var","B) Gerekiyor","C) Yapabilir / Yapabilmek","D) İstiyor"],
 correct:2,wrongFeedback:'"Can" = yapabilmek, gücü yetmek. "She can fly" = O uçabilir.',
 hint:"Can = ability (yetenek). Superman can fly!",
 simplified:{question:"Superman can fly. 'Can' ne anlama gelir?",options:["A) Uçmak zorunda","B) Uçabilir","C) Uçuyor","D) Uçtu"],correct:1,hint:"Can = yapabilmek!"}},

{id:"e023",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:1,type:"mc",
 question:'Boşluğu doldurun:\nSpiderman ___ climb walls.',
 options:["A) have","B) has","C) can","D) is"],
 correct:2,wrongFeedback:"Yetenek ifadesi için 'can' kullanılır. Spiderman can climb walls = Spiderman duvara tırmanabilir.",
 hint:"Yetenek = can. Climb = tırmanmak.",
 simplified:{question:"Yetenek anlatmak için hangi kelime kullanılır?",options:["A) have","B) can","C) is","D) are"],correct:1,hint:"Yetenek = can!"}},

{id:"e024",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:1,type:"mc",
 question:'"She has blue eyes." Türkçesi nedir?',
 options:["A) Onun mavi gözlü bir arabası var.","B) Onun mavi gözleri var.","C) O mavi gökyüzünü seviyor.","D) Onun mavi bir elbisesi var."],
 correct:1,wrongFeedback:'"Has" = var. "Blue eyes" = mavi gözler. She has blue eyes = Onun mavi gözleri var.',
 hint:"Has = var (she için). Eyes = gözler.",
 simplified:{question:'"Eyes" ne demek?',options:["A) Kulak","B) Burun","C) Göz","D) Ağız"],correct:2,hint:"Eyes = gözler!"}},

{id:"e025",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:2,type:"mc",
 question:'Boşluğu doldurun:\nThe cat ___ swim but it ___ fly.',
 options:["A) can / can","B) can / can't","C) can't / can","D) has / have"],
 correct:1,wrongFeedback:"Kedi yüzebilir ama uçamaz. can = yapabilir, can't = yapamaz.",
 hint:"Can't = yapamaz. Can = yapabilir.",
 simplified:{question:"Kedi uçabilir mi?",options:["A) Evet, uçabilir — can fly","B) Hayır, uçamaz — can't fly"],correct:1,hint:"Kediler uçamaz → can't fly!"}},

{id:"e026",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:2,type:"mc",
 question:'Okuma:\n"Tom is a cartoon cat. He has big ears and green eyes. He can run fast but he can\'t fly."\n\nTom has ___.',
 options:["A) small ears","B) big ears and green eyes","C) blue eyes","D) wings"],
 correct:1,wrongFeedback:"Metinde 'He has big ears and green eyes' yazıyor.",
 hint:"Metinde direkt yazıyor: big ears and green eyes.",
 simplified:{question:"Metinde Tom'un gözleri hangi renk?",options:["A) Blue","B) Brown","C) Green","D) Black"],correct:2,hint:"Metinde 'green eyes' yazıyor → yeşil gözler!"}},

{id:"e027",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:2,type:"mc",
 question:'Doğru cümleyi seç:\nSüperman\'ı tanımlayan cümle hangisi?',
 options:["A) He can't fly.","B) He has a red cape and can fly.","C) She has a cape.","D) He has wings."],
 correct:1,wrongFeedback:"Superman: erkek (he), kırmızı pelerin (red cape) var, uçabilir (can fly).",
 hint:"Cape = pelerin. Superman erkek → he.",
 simplified:{question:'"Cape" ne demek?',options:["A) Ayakkabı","B) Pelerin","C) Kask","D) Çizme"],correct:1,hint:"Cape = pelerin!"}},

{id:"e028",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:3,type:"mc",
 question:'Hangisi "have" ile hangisi "has" kullanır?\nI ___ / She ___',
 options:["A) has / have","B) have / has","C) have / have","D) has / has"],
 correct:1,wrongFeedback:"I have (ben için have). She has (he/she/it için has). I have → She has.",
 hint:"I/You/We/They = have. He/She/It = has.",
 simplified:{question:'"I" ve "She" için hangisi doğru?',options:["A) I has, She have","B) I have, She has"],correct:1,hint:"I → have. She → has. Kural bu!"}},

{id:"e029",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:3,type:"mc",
 question:'Boşlukları doldurun:\n"Pikachu ___ yellow fur. It ___ run fast."',
 options:["A) have / can","B) has / can","C) has / can't","D) have / can't"],
 correct:1,wrongFeedback:"Pikachu üçüncü tekil şahıs → has. Pikachu hızlı koşabilir → can.",
 hint:"It → has. Koşabilir → can.",
 simplified:{question:"It (o) için have mi has mi kullanılır?",options:["A) have","B) has"],correct:1,hint:"He/She/It → has!"}},

{id:"e030",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:3,type:"mc",
 question:'Okuma:\n"Elsa is a cartoon princess. She has long blonde hair. She can make ice and snow. She can\'t swim."\n\nElsa CAN\'T ___.',
 options:["A) make ice","B) make snow","C) swim","D) use magic"],
 correct:2,wrongFeedback:"Metinde 'She can't swim' yazıyor. Yüzme yapamaz.",
 hint:"Can't = yapamaz. Metinde hangisi yapamaz?",
 simplified:{question:"Metinde Elsa ne yapamıyor?",options:["A) Buz yapamıyor","B) Kar yapamıyor","C) Yüzemiyor","D) Uçamıyor"],correct:2,hint:"Metinde 'can't swim' = yüzemiyor!"}},

// ══ UNIT 4: FREE TIME (Hobbies, like + Ving) ══
{id:"e031",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:1,type:"mc",
 question:'"Play football" ne anlama gelir?',
 options:["A) Yüzmek","B) Futbol oynamak","C) Koşmak","D) Dans etmek"],
 correct:1,wrongFeedback:'"Play" = oynamak. "Football" = futbol. Play football = futbol oynamak.',
 hint:"Football = futbol. Play = oynamak.",
 simplified:{question:'"Football" ne demek?',options:["A) Basketbol","B) Voleybol","C) Futbol","D) Tenis"],correct:2,hint:"Football = futbol!"}},

{id:"e032",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:1,type:"mc",
 question:'"I like reading books." Türkçesi nedir?',
 options:["A) Kitap almayı seviyorum.","B) Kitap okumayı seviyorum.","C) Kitap yazmayı seviyorum.","D) Kitap kapamayı seviyorum."],
 correct:1,wrongFeedback:'"Like" = sevmek. "Reading" = okumak (-ing eki). "Books" = kitaplar. Like reading = okumayı sevmek.',
 hint:"Reading = okumak (-ing eki). Like = sevmek.",
 simplified:{question:'"Read" ne demek?',options:["A) Yazmak","B) Çizmek","C) Okumak","D) Saymak"],correct:2,hint:"Read = okumak → Reading = okumak (-ing)!"}},

{id:"e033",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:1,type:"mc",
 question:'"Watch TV" ne anlama gelir?',
 options:["A) TV açmak","B) TV izlemek","C) TV kapatmak","D) TV satın almak"],
 correct:1,wrongFeedback:'"Watch" = izlemek. "TV" = televizyon. Watch TV = TV izlemek.',
 hint:"Watch = izlemek (seyretmek).",
 simplified:{question:'"Watch" ne demek?',options:["A) Çalmak","B) İzlemek","C) Dinlemek","D) Okumak"],correct:1,hint:"Watch = izlemek!"}},

{id:"e034",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:1,type:"mc",
 question:'Boşluğu doldurun:\n"I like ___ to music." (müzik dinlemek)',
 options:["A) watching","B) playing","C) listening","D) reading"],
 correct:2,wrongFeedback:'"Listen to music" = müzik dinlemek. "Listening" (-ing eki ile). I like listening to music.',
 hint:"Müzik dinlemek = listen to music → listening.",
 simplified:{question:'"Listen" ne demek?',options:["A) İzlemek","B) Okumak","C) Dinlemek","D) Oynamak"],correct:2,hint:"Listen = dinlemek!"}},

{id:"e035",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:2,type:"mc",
 question:'Boşluğu doldurun:\n"She likes ___ pictures." (resim çizmek)',
 options:["A) watch","B) draw","C) drawing","D) reads"],
 correct:2,wrongFeedback:'"Like + Ving" kuralı: like + -ing eki. Draw = çizmek → Drawing. She likes drawing pictures.',
 hint:"Like + Ving kuralı! Draw → Drawing.",
 simplified:{question:'"Draw" ne demek?',options:["A) Boyamak","B) Çizmek","C) Kesmek","D) Yapıştırmak"],correct:1,hint:"Draw = çizmek!"}},

{id:"e036",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:2,type:"mc",
 question:'Diyalogu tamamla:\nAli: "What do you like doing?"\nSelin: "___ playing basketball."',
 options:["A) I don't like","B) I likes","C) I like","D) She likes"],
 correct:2,wrongFeedback:'"I like" = seviyorum. "I likes" yanlış (I için -s eklenmez). Ben = I like.',
 hint:"I + like (I likes YANLIŞ → I like DOĞRU).",
 simplified:{question:'"I" ile kullanılan doğru form hangisi?',options:["A) I likes","B) I like"],correct:1,hint:"I → like (s yok!)"}},

{id:"e037",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:2,type:"mc",
 question:'Hangi cümle doğrudur?',
 options:["A) He like swim.","B) He likes swimming.","C) He likes swim.","D) He like swimming."],
 correct:1,wrongFeedback:'"He" için "likes" (3. tekil, s eki). Like + Ving: likes + swimming. "He likes swimming" doğru.',
 hint:"He/She/It → likes. Like + Ving → swimming.",
 simplified:{question:'"He" için like mi likes mi kullanılır?',options:["A) like","B) likes"],correct:1,hint:"He → likes (3. tekil şahıs s eki)!"}},

{id:"e038",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:3,type:"mc",
 question:'Okuma:\n"Tom likes playing video games and watching movies. He doesn\'t like reading books."\n\nTom likes ___.',
 options:["A) reading books","B) playing video games and watching movies","C) playing basketball","D) listening to music"],
 correct:1,wrongFeedback:"Metinde 'Tom likes playing video games and watching movies' yazıyor.",
 hint:"Metinde 'likes' den sonra ne geliyor?",
 simplified:{question:"Metinde Tom'un neyi sevdiği yazıyor?",options:["A) Kitap okumayı","B) Video oyunu oynamayı ve film izlemeyi","C) Basketbol oynamayı","D) Müzik dinlemeyi"],correct:1,hint:"Metinde 'likes playing video games and watching movies'!"}},

{id:"e039",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:3,type:"mc",
 question:'Hangisi "I don\'t like"ın anlamıdır?',
 options:["A) Seviyorum","B) Sevmiyorum","C) Seviyor","D) Sevmiyor"],
 correct:1,wrongFeedback:'"Don\'t like" = sevmemek. "I don\'t like" = Sevmiyorum. Zıttı: I like = seviyorum.',
 hint:"Don't = değil/(-mez/-maz). I don't like = sevmiyorum.",
 simplified:{question:'"Don\'t" ne anlam katar?',options:["A) Olumlu yapar","B) Olumsuz yapar (değil/mez)"],correct:1,hint:"Don't = olumsuzluk!"}},

{id:"e040",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:3,type:"mc",
 question:'Doğru soruyu bul:\n"___ does Ayşe like doing?"\nCevap: She likes dancing.',
 options:["A) Who","B) Where","C) What","D) When"],
 correct:2,wrongFeedback:'"What does she like doing?" = O ne yapmaktan hoşlanır? Cevap: She likes dancing.',
 hint:"Ne? = What. Aktivite soru kelimesi = What.",
 simplified:{question:'"What" ne demek?',options:["A) Nerede","B) Kim","C) Ne","D) Ne zaman"],correct:2,hint:"What = ne!"}},

// ══ UNIT 5: MY DAY (Daily Routines) ══
{id:"e041",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:1,type:"mc",
 question:'"Wake up" ne anlama gelir?',
 options:["A) Uyumak","B) Uyanmak","C) Giyinmek","D) Yıkanmak"],
 correct:1,wrongFeedback:'"Wake up" = uyanmak. "Go to sleep" = uyumak. Sabah "wake up" ederiz.',
 hint:"Wake = uyanmak. Up = yukarı (yataktan kalk).",
 simplified:{question:"Sabah ilk ne yaparsın?",options:["A) Uyursun","B) Uyanırsın (wake up)"],correct:1,hint:"Güne başlamak = wake up = uyanmak!"}},

{id:"e042",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:1,type:"mc",
 question:'"Have breakfast" ne anlama gelir?',
 options:["A) Kahvaltı etmek","B) Akşam yemeği yemek","C) Öğle yemeği yemek","D) Kahve içmek"],
 correct:0,wrongFeedback:'"Breakfast" = kahvaltı. "Have breakfast" = kahvaltı etmek.',
 hint:"Breakfast = kahvaltı. Break + fast = orucu bozma.",
 simplified:{question:'"Breakfast" ne demek?',options:["A) Akşam yemeği","B) Öğle yemeği","C) Kahvaltı","D) Atıştırmalık"],correct:2,hint:"Breakfast = kahvaltı!"}},

{id:"e043",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:1,type:"mc",
 question:'"Go to school" ne anlama gelir?',
 options:["A) Okuldan çıkmak","B) Okula gitmek","C) Okulda uyumak","D) Okul açmak"],
 correct:1,wrongFeedback:'"Go to" = -e gitmek. "School" = okul. Go to school = okula gitmek.',
 hint:"Go to = gitmek. School = okul.",
 simplified:{question:'"School" ne demek?',options:["A) Ev","B) Okul","C) Park","D) Hastane"],correct:1,hint:"School = okul!"}},

{id:"e044",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:1,type:"mc",
 question:'"Brush teeth" ne anlama gelir?',
 options:["A) Yüz yıkamak","B) Saç taramak","C) Diş fırçalamak","D) Banyo yapmak"],
 correct:2,wrongFeedback:'"Brush" = fırçalamak. "Teeth" = dişler. Brush teeth = diş fırçalamak.',
 hint:"Teeth = dişler (çoğul). Brush = fırçalamak.",
 simplified:{question:'"Teeth" ne demek?',options:["A) Saç","B) Tırnak","C) Diş(ler)","D) Dudak"],correct:2,hint:"Teeth = dişler (tooth'un çoğulu)!"}},

{id:"e045",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:2,type:"mc",
 question:'Boşluğu doldurun:\n"Ayşe ___ to school at 8 o\'clock." (gider)',
 options:["A) go","B) goes","C) going","D) gone"],
 correct:1,wrongFeedback:"Ayşe = o (she) = üçüncü tekil şahıs → go + es = goes. Simple Present kural.",
 hint:"She/He/It → go + es = goes!",
 simplified:{question:'"She" için go mu goes mi kullanılır?',options:["A) go","B) goes"],correct:1,hint:"She → goes (3. tekil şahıs s/es eki)!"}},

{id:"e046",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:2,type:"mc",
 question:'Saat sorusu:\n"It\'s seven o\'clock." Türkçesi nedir?',
 options:["A) Saat yediyi çeyrek geçiyor.","B) Saat yedi buçuk.","C) Saat tam yedi.","D) Saat yediyi çeyrek var."],
 correct:2,wrongFeedback:'"O\'clock" = tam saat anlamına gelir. It\'s seven o\'clock = Saat tam yedi.',
 hint:"O'clock = tam saat. Seven = yedi.",
 simplified:{question:'"O\'clock" ne demek?',options:["A) Buçuk","B) Çeyrek","C) Tam saat","D) Dakika"],correct:2,hint:"O'clock = tam saat!"}},

{id:"e047",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:2,type:"mc",
 question:'Günlük rutini doğru sıraya koy:\n1. Have breakfast\n2. Wake up\n3. Go to school\n4. Brush teeth',
 options:["A) 1-2-3-4","B) 2-4-1-3","C) 2-1-4-3","D) 3-2-1-4"],
 correct:1,wrongFeedback:"Sabah sırası: Wake up (uyan) → Brush teeth (diş fırçala) → Have breakfast (kahvaltı) → Go to school (okula git).",
 hint:"Önce uyan, sonra diş fırçala, sonra kahvaltı, sonra okul.",
 simplified:{question:"Sabahları önce mi diş fırçalarsın yoksa kahvaltı mı edersin?",options:["A) Önce kahvaltı","B) Genelde önce diş fırçalarsın"],correct:1,hint:"Wake up → brush teeth → breakfast → school!"}},

{id:"e048",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:2,type:"mc",
 question:'Boşluğu doldurun:\n"I ___ my homework after school." (yaparım)',
 options:["A) does","B) doing","C) do","D) done"],
 correct:2,wrongFeedback:'"I" ile "do" kullanılır (does değil). I do my homework = ödevimi yaparım.',
 hint:"I → do. He/She/It → does.",
 simplified:{question:'"I" için do mu does mi kullanılır?',options:["A) does","B) do"],correct:1,hint:"I → do (I does YANLIŞ)!"}},

{id:"e049",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:3,type:"mc",
 question:'Okuma:\n"Ali wakes up at 7:00. He brushes his teeth and has breakfast. He goes to school at 8:00."\n\nAli goes to school at ___.',
 options:["A) 7:00","B) 8:30","C) 8:00","D) 9:00"],
 correct:2,wrongFeedback:"Metinde 'He goes to school at 8:00' yazıyor.",
 hint:"Metinde school saatine bak: 'goes to school at...'",
 simplified:{question:"Metinde Ali okula kaçta gidiyor?",options:["A) 7:00","B) 8:00","C) 9:00","D) 10:00"],correct:1,hint:"Metinde '8:00' yazıyor!"}},

{id:"e050",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:3,type:"mc",
 question:'"What time do you wake up?"\nDoğru cevap hangisi?',
 options:["A) I wake up at 7 o'clock.","B) I wakes up at 7 o'clock.","C) She wake up at 7 o'clock.","D) I wake up in 7 o'clock."],
 correct:0,wrongFeedback:'"I wake up at 7 o\'clock." doğru. I→wake (not wakes). At + time (not in).',
 hint:"I → wake (s yok). Saat için at kullanılır (in değil).",
 simplified:{question:"Saat için hangi edat kullanılır? 'I wake up ___ 7.'",options:["A) in","B) on","C) at","D) to"],correct:2,hint:"Saat + at → at 7 o'clock!"}},

// ══ UNIT 6: FUN WITH SCIENCE (Instructions, Prepositions) ══
{id:"e051",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:1,type:"mc",
 question:'"Put" ne anlama gelir?',
 options:["A) Almak","B) Atmak","C) Koymak","D) Karıştırmak"],
 correct:2,wrongFeedback:'"Put" = koymak, yerleştirmek. "Put the book on the table" = kitabı masaya koy.',
 hint:"Put = koymak. Put it here = bunu buraya koy.",
 simplified:{question:"'Put the cup on the table' — Put ne demek?",options:["A) Al","B) Koy","C) Taşı","D) Ver"],correct:1,hint:"Put = koymak!"}},

{id:"e052",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:1,type:"mc",
 question:'"Mix" ne anlama gelir?',
 options:["A) Kesmek","B) Karıştırmak","C) Dökmek","D) Sıkıştırmak"],
 correct:1,wrongFeedback:'"Mix" = karıştırmak. Bilim deneyinde maddeleri karıştırmak için kullanılır.',
 hint:"Mix = karıştır. Mixte = karışım.",
 simplified:{question:"Fen deneyinde malzemeleri bir araya getirip çevirmek ne demek?",options:["A) Cut (kes)","B) Mix (karıştır)","C) Pour (dök)","D) Shake (salla)"],correct:1,hint:"Mix = karıştır!"}},

{id:"e053",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:1,type:"mc",
 question:'"The ball is under the chair." Türkçesi nedir?',
 options:["A) Top sandalyenin üstünde.","B) Top sandalyenin yanında.","C) Top sandalyenin altında.","D) Top sandalyenin arkasında."],
 correct:2,wrongFeedback:'"Under" = altında. "The ball is under the chair" = Top sandalyenin altında.',
 hint:"Under = altında. On = üstünde. Next to = yanında.",
 simplified:{question:'"Under" ne demek?',options:["A) Üstünde","B) Yanında","C) Altında","D) Arkasında"],correct:2,hint:"Under = altında!"}},

{id:"e054",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:1,type:"mc",
 question:'"The book is on the table." Türkçesi nedir?',
 options:["A) Kitap masanın altında.","B) Kitap masanın üstünde.","C) Kitap masanın yanında.","D) Kitap masanın arkasında."],
 correct:1,wrongFeedback:'"On" = üstünde. "The book is on the table" = Kitap masanın üstünde.',
 hint:"On = üstünde (temas halinde). Above = yukarısında.",
 simplified:{question:'"On" ne demek?',options:["A) Altında","B) Üstünde","C) İçinde","D) Yanında"],correct:1,hint:"On = üstünde!"}},

{id:"e055",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:2,type:"mc",
 question:'Boşluğu doldurun:\n"The cat is ___ the box." (kutunun içinde)',
 options:["A) on","B) under","C) in","D) next to"],
 correct:2,wrongFeedback:'"In" = içinde. "The cat is in the box" = Kedi kutunun içinde.',
 hint:"İçinde = in. On=üstünde, Under=altında.",
 simplified:{question:'"In" ne demek?',options:["A) Üstünde","B) Altında","C) İçinde","D) Yanında"],correct:2,hint:"In = içinde!"}},

{id:"e056",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:2,type:"mc",
 question:'Talimatı tamamla:\n"First, ___ water in the bottle. Then, add sugar."',
 options:["A) mix","B) put","C) shake","D) cut"],
 correct:1,wrongFeedback:'"Put water in the bottle" = şişeye su koy. Deney talimatı: önce koy, sonra ekle.',
 hint:"İlk adım: suyu şişeye koy → put.",
 simplified:{question:'"Put" ne demek?',options:["A) Çıkar","B) Koy","C) Karıştır","D) Salla"],correct:1,hint:"Put = koy!"}},

{id:"e057",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:2,type:"mc",
 question:'"Where is the pencil?" sorusuna doğru cevap hangisi?',
 options:["A) It is a pencil.","B) The pencil is on the desk.","C) It is blue.","D) I have a pencil."],
 correct:1,wrongFeedback:'"Where is...?" = ...nerede? Cevap: "It is on the desk" veya "The pencil is on the desk."',
 hint:"Where = nerede? → On, under, in, next to gibi konum cevabı.",
 simplified:{question:'"Where" sorusuna hangi tür cevap verilir?',options:["A) Renk","B) Yer/Konum","C) Boyut","D) Sayı"],correct:1,hint:"Where = nerede → konum cevabı!"}},

{id:"e058",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:3,type:"mc",
 question:'Deney talimatını doğru sırala:\n1. Mix the colours.\n2. Add water.\n3. Put the paint in a cup.\n4. Use the brush.',
 options:["A) 1-2-3-4","B) 3-2-1-4","C) 2-3-1-4","D) 4-3-2-1"],
 correct:1,wrongFeedback:"Sıra: Put paint in cup → Add water → Mix → Use brush. (3-2-1-4)",
 hint:"Önce boyanı koy, sonra su ekle, sonra karıştır, sonra fırça kullan.",
 simplified:{question:"Deney sırasında önce ne yapılır?",options:["A) Karıştır","B) Boyanı kaba koy","C) Su ekle","D) Fırça kullan"],correct:1,hint:"Önce put (koy), sonra add (ekle), sonra mix (karıştır)!"}},

{id:"e059",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:3,type:"mc",
 question:'Okuma:\n"The pencil is next to the ruler. The eraser is under the book. The scissors are on the desk."\n\nThe eraser is ___.',
 options:["A) on the desk","B) next to the ruler","C) under the book","D) in the bag"],
 correct:2,wrongFeedback:"Metinde 'The eraser is under the book' yazıyor. Silgi kitabın altında.",
 hint:"Eraser = silgi. Metinde nerede?",
 simplified:{question:'"Eraser" ne demek?',options:["A) Cetvel","B) Kalem","C) Silgi","D) Makas"],correct:2,hint:"Eraser = silgi!"}},

{id:"e060",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:3,type:"mc",
 question:'"Next to" ne anlama gelir?',
 options:["A) Önünde","B) Arkasında","C) Yanında","D) Üstünde"],
 correct:2,wrongFeedback:'"Next to" = yanında, hemen yanı. "The cat is next to the door" = Kedi kapının yanında.',
 hint:"Next = bir sonraki, yanı. Next to = yanında.",
 simplified:{question:"Kapının yanında durmak = next to. Next to ne demek?",options:["A) İçinde","B) Üstünde","C) Yanında","D) Altında"],correct:2,hint:"Next to = yanında!"}},

// ══ UNIT 7: JOBS ══
{id:"e061",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:1,type:"mc",
 question:'"Doctor" ne anlama gelir?',
 options:["A) Öğretmen","B) Doktor","C) İtfaiyeci","D) Polis"],
 correct:1,wrongFeedback:'"Doctor" = doktor. A doctor works in a hospital.',
 hint:"Doctor = doktor. Hospital = hastane.",
 simplified:{question:"Hastanede çalışan kişiye ne denir?",options:["A) Teacher","B) Doctor","C) Pilot","D) Chef"],correct:1,hint:"Hastane = hospital → Doctor (doktor)!"}},

{id:"e062",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:1,type:"mc",
 question:'"Firefighter" ne anlama gelir?',
 options:["A) Polis memuru","B) Hemşire","C) İtfaiyeci","D) Şoför"],
 correct:2,wrongFeedback:'"Firefighter" = itfaiyeci. Fire = ateş, fighter = savaşan.',
 hint:"Fire = ateş. Fighter = savaşan. Firefighter = ateşle savaşan = itfaiyeci.",
 simplified:{question:'"Fire" ne demek?',options:["A) Su","B) Hava","C) Ateş","D) Toprak"],correct:2,hint:"Fire = ateş → Firefighter = itfaiyeci!"}},

{id:"e063",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:1,type:"mc",
 question:'"Where does a teacher work?" sorusunun doğru cevabı hangisi?',
 options:["A) In a hospital","B) In a school","C) In a restaurant","D) In an airport"],
 correct:1,wrongFeedback:"Teacher (öğretmen) bir okulda çalışır. Hospital=hastane, Restaurant=restoran, Airport=havalimanı.",
 hint:"Teacher = öğretmen → School = okul.",
 simplified:{question:'"School" ne demek?',options:["A) Hastane","B) Okul","C) Restoran","D) Havalimanı"],correct:1,hint:"School = okul → Teacher works in a school!"}},

{id:"e064",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:1,type:"mc",
 question:'"Chef" ne anlama gelir?',
 options:["A) Garson","B) Kasap","C) Şef / Aşçı","D) Fırıncı"],
 correct:2,wrongFeedback:'"Chef" = aşçı, şef. A chef works in a restaurant.',
 hint:"Chef = aşçı. Restaurant = restoran.",
 simplified:{question:"Restoranda yemek pişiren kişi kim?",options:["A) Pilot","B) Chef (aşçı)","C) Doctor","D) Teacher"],correct:1,hint:"Restoranda yemek pişiren = Chef!"}},

{id:"e065",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:2,type:"mc",
 question:'Boşluğu doldurun:\n"She is a nurse. She works ___ a hospital."',
 options:["A) at","B) on","C) in","D) to"],
 correct:2,wrongFeedback:'"Works in a hospital" = hastanede çalışır. Yer bildirirken büyük yerler için "in" kullanılır.',
 hint:"Büyük yer (hastane, okul) + in. Works in a hospital.",
 simplified:{question:"Büyük yerlerde (hastane, okul) çalışmak için hangi edat?",options:["A) on","B) at","C) in","D) to"],correct:2,hint:"In a hospital / in a school!"}},

{id:"e066",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:2,type:"mc",
 question:'Okuma:\n"My dad is a pilot. He works at an airport. He likes flying planes."\n\nWhat does his dad do?',
 options:["A) He is a doctor.","B) He is a teacher.","C) He is a pilot.","D) He is a chef."],
 correct:2,wrongFeedback:"Metinde 'My dad is a pilot' yazıyor. Babası pilottur.",
 hint:"Metinde 'is a pilot' yazıyor.",
 simplified:{question:"Metinde baba ne iş yapıyor?",options:["A) Doktor","B) Öğretmen","C) Pilot","D) Aşçı"],correct:2,hint:"Metinde 'is a pilot' = pilottur!"}},

{id:"e067",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:2,type:"mc",
 question:'Meslek eşleştirmesi:\n"He saves people in fires." → Kim?',
 options:["A) Doctor","B) Teacher","C) Firefighter","D) Pilot"],
 correct:2,wrongFeedback:"'Saves people in fires' = yangınlarda insanları kurtarır → Firefighter (itfaiyeci).",
 hint:"Save in fires = yangında kurtarmak = firefighter.",
 simplified:{question:"Yangında insanları kurtaran kişi kim?",options:["A) Doctor","B) Firefighter","C) Chef","D) Pilot"],correct:1,hint:"Yangın = fire → Firefighter (itfaiyeci)!"}},

{id:"e068",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:3,type:"mc",
 question:'Diyalogu tamamla:\nAli: "What does your mother do?"\nSelin: "___ a nurse."',
 options:["A) I am","B) He is","C) She is","D) They are"],
 correct:2,wrongFeedback:"'Mother' (anne) = she. She is a nurse. Anneden bahsedilirken 'she' kullanılır.",
 hint:"Anne = she. She is a nurse.",
 simplified:{question:"Anne için hangi zamir kullanılır?",options:["A) He","B) She","C) It","D) They"],correct:1,hint:"Anne = kadın = She!"}},

{id:"e069",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:3,type:"mc",
 question:'Hangisi doğru cümledir?',
 options:["A) A teacher work in a school.","B) A teacher works in a school.","C) A teacher working in a school.","D) A teacher worked in a school."],
 correct:1,wrongFeedback:"'A teacher' = üçüncü tekil şahıs → works (s eki). 'A teacher works in a school' doğru.",
 hint:"A teacher = üçüncü tekil → works (s eki zorunlu).",
 simplified:{question:"'A teacher' için work mi works mi?",options:["A) work","B) works"],correct:1,hint:"A teacher (tek kişi) → works (s eki)!"}},

{id:"e070",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:3,type:"mc",
 question:'Okuma:\n"Berk wants to be a pilot. He likes travelling and he can fly small planes."\n\nWhy does Berk want to be a pilot?',
 options:["A) Because he likes cooking.","B) Because he likes travelling and can fly planes.","C) Because he works in an airport.","D) Because his father is a pilot."],
 correct:1,wrongFeedback:"Metinde 'He likes travelling and he can fly small planes' yazıyor. Bu nedenle pilot olmak istiyor.",
 hint:"Because = çünkü. Metinde neden yazıyor?",
 simplified:{question:"Metinde Berk neden pilot olmak istiyor?",options:["A) Yemek yapmayı seviyor","B) Seyahat etmeyi seviyor ve uçak kullanabiliyor","C) Havalimanında çalışıyor","D) Babası pilot"],correct:1,hint:"Metinde 'likes travelling and can fly planes' yazıyor!"}},

// ══ UNIT 8: MY CLOTHES ══
{id:"e071",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:1,type:"mc",
 question:'"T-shirt" ne anlama gelir?',
 options:["A) Gömlek","B) Tişört","C) Mont","D) Kazak"],
 correct:1,wrongFeedback:'"T-shirt" = tişört. Yazın çok kullanılan kıyafet.',
 hint:"T-shirt = tişört (T şeklindeki giysi).",
 simplified:{question:"Yazın giyilen kısa kollu giysi ne?",options:["A) Jacket","B) T-shirt","C) Coat","D) Scarf"],correct:1,hint:"T-shirt = tişört!"}},

{id:"e072",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:1,type:"mc",
 question:'"Jacket" ne anlama gelir?',
 options:["A) Şapka","B) Etek","C) Ceket / Mont","D) Elbise"],
 correct:2,wrongFeedback:'"Jacket" = ceket, kısa mont.',
 hint:"Jacket = ceket. Sonbahar/kış için.",
 simplified:{question:"Ceket giymek için hangi kelime?",options:["A) Hat","B) Jacket","C) Dress","D) Shoes"],correct:1,hint:"Jacket = ceket!"}},

{id:"e073",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:1,type:"mc",
 question:'"What is he wearing?" sorusunun Türkçesi nedir?',
 options:["A) O ne renk?","B) O ne giyiyor?","C) Onun kıyafeti ne?","D) O nereli?"],
 correct:1,wrongFeedback:'"What is he wearing?" = O ne giyiyor? "Wear" = giymek.',
 hint:"Wearing = giymek (-ing form). What = ne.",
 simplified:{question:'"Wear" ne demek?',options:["A) Taşımak","B) Giymek","C) Almak","D) Satmak"],correct:1,hint:"Wear = giymek!"}},

{id:"e074",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:1,type:"mc",
 question:'"It\'s cold. Wear your ___." (atkı / eşarp)',
 options:["A) shorts","B) sandals","C) scarf","D) sunglasses"],
 correct:2,wrongFeedback:'"Scarf" = atkı, eşarp. Soğuk havada atkı takılır.',
 hint:"Soğuk hava + boyun = scarf (atkı).",
 simplified:{question:'"Scarf" ne demek?',options:["A) Eldiven","B) Şapka","C) Atkı / Eşarp","D) Çorap"],correct:2,hint:"Scarf = atkı!"}},

{id:"e075",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:2,type:"mc",
 question:'Hava durumu → kıyafet:\n"It\'s snowing. You should wear ___."',
 options:["A) shorts and sandals","B) a coat and boots","C) a T-shirt and cap","D) a dress and sunglasses"],
 correct:1,wrongFeedback:"Kar yağıyorsa: coat (palto) + boots (çizme) giyilir. Sıcak kıyafetler gerekir.",
 hint:"Snowing = kar yağıyor → sıcak kıyafet gerek.",
 simplified:{question:"Kar yağarken ne giyersin?",options:["A) Şort ve sandalet","B) Palto ve çizme"],correct:1,hint:"Soğuk = Coat + Boots!"}},

{id:"e076",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:2,type:"mc",
 question:'Boşluğu doldurun:\n"She is wearing a red ___ and blue jeans." (elbise)',
 options:["A) trousers","B) dress","C) shoes","D) jacket"],
 correct:1,wrongFeedback:'"Dress" = elbise. She is wearing a red dress = O kırmızı elbise giyiyor.',
 hint:"Dress = elbise (tek parça).",
 simplified:{question:'"Dress" ne demek?',options:["A) Şort","B) Elbise","C) Gömlek","D) Pantolon"],correct:1,hint:"Dress = elbise!"}},

{id:"e077",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:2,type:"mc",
 question:'Okuma:\n"Ali is wearing a blue shirt, grey trousers and black shoes."\n\nWhat colour are Ali\'s trousers?',
 options:["A) Blue","B) Black","C) Grey","D) White"],
 correct:2,wrongFeedback:"Metinde 'grey trousers' yazıyor. Gri pantolon.",
 hint:"Trousers = pantolon. Metinde hangi renk?",
 simplified:{question:'"Trousers" ne demek?',options:["A) Gömlek","B) Ayakkabı","C) Pantolon","D) Şapka"],correct:2,hint:"Trousers = pantolon!"}},

{id:"e078",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:3,type:"mc",
 question:'Mevsim → kıyafet eşleştirmesi:\nSummer (Yaz) →',
 options:["A) Coat, boots and scarf","B) Shorts, T-shirt and sandals","C) Jacket, trousers and shoes","D) Sweater, hat and gloves"],
 correct:1,wrongFeedback:"Yaz = sıcak → shorts (şort) + T-shirt + sandals (sandalet).",
 hint:"Summer = yaz = sıcak → hafif kıyafetler.",
 simplified:{question:"Yazın ne giyersin?",options:["A) Palto","B) Şort ve tişört","C) Mont","D) Kazak"],correct:1,hint:"Yaz = sıcak = shorts + T-shirt!"}},

{id:"e079",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:3,type:"mc",
 question:'Diyalogu tamamla:\nMother: "It\'s raining outside. ___ your raincoat."\nChild: "OK, mum."',
 options:["A) Take off","B) Put on","C) Sit down","D) Stand up"],
 correct:1,wrongFeedback:'"Put on" = giymek (bir şey giyinmek). "Take off" = çıkarmak. Yağmur yağıyor → yağmurluk giy = put on.',
 hint:"Put on = giy. Take off = çıkar. Zıt anlamlı!",
 simplified:{question:'"Put on" ne demek?',options:["A) Çıkarmak","B) Giymek"],correct:1,hint:"Put on = giymek (kıyafet için)!"}},

{id:"e080",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:3,type:"mc",
 question:'Hangisi yanlış eşleştirmedir?\nKıyafet → Türkçe',
 options:["A) hat → şapka","B) gloves → eldiven","C) socks → şapka","D) shoes → ayakkabı"],
 correct:2,wrongFeedback:'"Socks" = çorap (şapka değil). Şapka = hat. C yanlış.',
 hint:"Socks = çorap. Hat = şapka. Karıştırma!",
 simplified:{question:'"Socks" ne demek?',options:["A) Şapka","B) Eldiven","C) Çorap","D) Ayakkabı"],correct:2,hint:"Socks = çorap!"}},

// ══ UNIT 9: MY FRIENDS ══
{id:"e081",subject:"ingilizce",kazanim:409,kazanimName:"My Friends",difficulty:1,type:"mc",
 question:'"Tall" ne anlama gelir?',
 options:["A) Kısa boylu","B) Uzun boylu","C) Şişman","D) İnce"],
 correct:1,wrongFeedback:'"Tall" = uzun boylu. Zıttı: "Short" = kısa boylu.',
 hint:"Tall = uzun boylu. Short = kısa boylu. Zıtlar!",
 simplified:{question:"Uzun boylu = tall. Kısa boylu = ?",options:["A) Fat","B) Thin","C) Short","D) Curly"],correct:2,hint:"Tall ↔ Short (zıt)!"}},

{id:"e082",subject:"ingilizce",kazanim:409,kazanimName:"My Friends",difficulty:1,type:"mc",
 question:'"She has curly hair." Türkçesi nedir?',
 options:["A) Onun düz saçları var.","B) Onun uzun saçları var.","C) Onun kıvırcık saçları var.","D) Onun sarı saçları var."],
 correct:2,wrongFeedback:'"Curly hair" = kıvırcık saç. "Straight hair" = düz saç.',
 hint:"Curly = kıvırcık. Straight = düz.",
 simplified:{question:'"Curly" ne demek?',options:["A) Düz","B) Uzun","C) Kıvırcık","D) Kısa"],correct:2,hint:"Curly = kıvırcık!"}},

{id:"e083",subject:"ingilizce",kazanim:409,kazanimName:"My Friends",difficulty:1,type:"mc",
 question:'"He has brown eyes." Türkçesi nedir?',
 options:["A) Onun mavi gözleri var.","B) Onun yeşil gözleri var.","C) Onun kahverengi gözleri var.","D) Onun siyah gözleri var."],
 correct:2,wrongFeedback:'"Brown" = kahverengi. "Brown eyes" = kahverengi gözler.',
 hint:"Brown = kahverengi. Blue = mavi. Green = yeşil.",
 simplified:{question:'"Brown" ne demek?',options:["A) Mavi","B) Yeşil","C) Kahverengi","D) Sarı"],correct:2,hint:"Brown = kahverengi!"}},

{id:"e084",subject:"ingilizce",kazanim:409,kazanimName:"My Friends",difficulty:1,type:"mc",
 question:'Boşluğu doldurun:\n"My friend ___ long blonde hair." (var)',
 options:["A) have","B) has","C) is","D) are"],
 correct:1,wrongFeedback:'"My friend" = üçüncü tekil şahıs → "has". My friend has long blonde hair.',
 hint:"My friend = he/she = has kullanılır.",
 simplified:{question:"Üçüncü tekil şahıs için have mi has mi?",options:["A) have","B) has"],correct:1,hint:"He/She/It → has!"}},

{id:"e085",subject:"ingilizce",kazanim:409,kazanimName:"My Friends",difficulty:2,type:"mc",
 question:'Kişiyi tanımla:\n"She is tall. She has long straight hair and green eyes."\nBu kişi kim olabilir?',
 options:["A) Uzun boylu, kıvırcık saçlı, mavi gözlü","B) Kısa boylu, düz saçlı, yeşil gözlü","C) Uzun boylu, düz saçlı, yeşil gözlü","D) Uzun boylu, sarı saçlı, kahve gözlü"],
 correct:2,wrongFeedback:"Metinde: tall (uzun boylu) + long straight hair (düz saç) + green eyes (yeşil göz).",
 hint:"Tall=uzun, straight=düz, green=yeşil. Üçü birlikte hangi şık?",
 simplified:{question:'"Straight hair" ne demek?',options:["A) Kıvırcık saç","B) Kısa saç","C) Düz saç","D) Sarı saç"],correct:2,hint:"Straight = düz → straight hair = düz saç!"}},

{id:"e086",subject:"ingilizce",kazanim:409,kazanimName:"My Friends",difficulty:2,type:"mc",
 question:'Okuma:\n"My best friend is Berk. He is tall and thin. He has short dark hair and blue eyes. He likes playing basketball."\n\nBerk has ___ hair.',
 options:["A) long blonde","B) short dark","C) curly red","D) straight brown"],
 correct:1,wrongFeedback:"Metinde 'short dark hair' yazıyor = kısa, koyu saç.",
 hint:"Hair = saç. Metinde hangi saç var?",
 simplified:{question:'"Dark" ne demek?',options:["A) Açık","B) Uzun","C) Koyu","D) Kıvırcık"],correct:2,hint:"Dark = koyu (renk)!"}},

{id:"e087",subject:"ingilizce",kazanim:409,kazanimName:"My Friends",difficulty:2,type:"mc",
 question:'Diyalogu tamamla:\nAli: "Who is your best friend?"\nSelin: "___ name is Derya."',
 options:["A) His","B) Her","C) My","D) Your"],
 correct:1,wrongFeedback:"Derya = kız ismi = she/her. 'Her name is Derya' = Onun adı Derya (dişil sahiplik).",
 hint:"Kız arkadaş → her (dişil iyelik). Erkek → his.",
 simplified:{question:"Kız için iyelik sıfatı hangisi?",options:["A) his","B) her","C) its","D) my"],correct:1,hint:"Kız = she → her (dişil iyelik)!"}},

{id:"e088",subject:"ingilizce",kazanim:409,kazanimName:"My Friends",difficulty:3,type:"mc",
 question:'Kişi tanımlayan doğru cümle hangisi?',
 options:["A) She have brown hair.","B) She has a tall.","C) She has brown hair and she is tall.","D) She is having brown hair."],
 correct:2,wrongFeedback:'"She has brown hair" (have değil has) + "she is tall" (is, has değil). C doğru yapı.',
 hint:"Saç için has. Boy için is. İki cümleyi and ile birleştir.",
 simplified:{question:"Saç için has mi is mi kullanılır?",options:["A) is","B) has"],correct:1,hint:"Sahiplik (saç, göz) → has. Sıfat (uzun, kısa) → is!"}},

{id:"e089",subject:"ingilizce",kazanim:409,kazanimName:"My Friends",difficulty:3,type:"mc",
 question:'Arkadaşını tanıtırken doğru sıra:\n1. He has curly hair.\n2. His name is Berk.\n3. He likes football.\n4. He is tall.',
 options:["A) 3-2-1-4","B) 2-4-1-3","C) 1-2-3-4","D) 4-3-2-1"],
 correct:1,wrongFeedback:"Mantıklı sıra: İsim ver (2) → Fiziksel özellik (4, 1) → Sevdiği (3). 2-4-1-3.",
 hint:"Önce kim olduğu (isim), sonra nasıl göründüğü, sonra ne sevdiği.",
 simplified:{question:"Birini tanıtırken ilk ne söylenir?",options:["A) Ne sevdiği","B) İsmi","C) Boyu","D) Saç rengi"],correct:1,hint:"Önce isim: 'His name is...'!"}},

{id:"e090",subject:"ingilizce",kazanim:409,kazanimName:"My Friends",difficulty:3,type:"mc",
 question:'Hangisi yanlış tanımlamadır?',
 options:["A) He is short and thin.","B) She has long curly hair.","C) He have blue eyes.","D) She is tall and has brown hair."],
 correct:2,wrongFeedback:'"He have" YANLIŞ. He = üçüncü tekil → He HAS blue eyes. A, B, D doğru.',
 hint:"He → has (have değil!).",
 simplified:{question:'"He" için have mi has mi kullanılır?',options:["A) He have","B) He has"],correct:1,hint:"He → has (have YANLIŞ)!"}},

// ══ UNIT 10: FOOD & DRINKS ══
{id:"e091",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:1,type:"mc",
 question:'"Apple" ne anlama gelir?',
 options:["A) Muz","B) Üzüm","C) Elma","D) Portakal"],
 correct:2,wrongFeedback:'"Apple" = elma. Banana = muz, Grape = üzüm, Orange = portakal.',
 hint:"Apple = elma. An apple a day keeps the doctor away!",
 simplified:{question:"Elma'nın İngilizcesi nedir?",options:["A) Banana","B) Grape","C) Apple","D) Orange"],correct:2,hint:"Apple = elma!"}},

{id:"e092",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:1,type:"mc",
 question:'"I don\'t like pizza." Türkçesi nedir?',
 options:["A) Pizza seviyorum.","B) Pizza sevmiyorum.","C) Pizza yiyorum.","D) Pizza istiyorum."],
 correct:1,wrongFeedback:'"Don\'t like" = sevmemek. I don\'t like pizza = Pizza sevmiyorum.',
 hint:"Don't = olumsuzluk. Don't like = sevmemek.",
 simplified:{question:'"Don\'t like" ne demek?',options:["A) Sevmek","B) Sevmemek"],correct:1,hint:"Don't = değil → don't like = sevmemek!"}},

{id:"e093",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:1,type:"mc",
 question:'"Would you like some juice?" sorusunun Türkçesi nedir?',
 options:["A) Biraz meyve suyun var mı?","B) Biraz meyve suyu ister misin?","C) Meyve suyunu içiyor musun?","D) Meyve suyu satar mısın?"],
 correct:1,wrongFeedback:'"Would you like" = ister misin? Kibarca teklif etmek için kullanılır.',
 hint:"Would you like = ister misin? (kibarca teklif).",
 simplified:{question:'"Would you like...?" ne demek?',options:["A) ...var mı?","B) ...ister misin?","C) ...sever misin?","D) ...içiyor musun?"],correct:1,hint:"Would you like = ister misin?"}},

{id:"e094",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:1,type:"mc",
 question:'Boşluğu doldurun:\n"___, I\'d like a glass of milk, please."',
 options:["A) No, thanks","B) I don't like","C) Yes, please","D) I hate"],
 correct:2,wrongFeedback:'"Yes, please" = Evet, lütfen (kabul ederken). "No, thanks" = Hayır, teşekkürler (reddederken).',
 hint:"Kabul etmek = Yes, please. Reddetmek = No, thanks.",
 simplified:{question:"Teklif kabul edildiğinde ne denir?",options:["A) No, thanks","B) Yes, please"],correct:1,hint:"Kabul = Yes, please!"}},

{id:"e095",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:2,type:"mc",
 question:'Restoran diyalogu:\nWaiter: "What would you like?"\nCustomer: "___"\nDoğru cevap hangisi?',
 options:["A) I am a sandwich.","B) I'd like a sandwich, please.","C) I like a sandwich.","D) Sandwich please me."],
 correct:1,wrongFeedback:'"I\'d like" = istiyorum (I would like\'ın kısa hali). Sipariş verirken kullanılır.',
 hint:"Sipariş = I'd like... (would like kısa hali).",
 simplified:{question:'"I\'d like" ne demek?',options:["A) Seviyorum","B) İstiyorum (kibarca)","C) Yiyorum","D) İhtiyacım var"],correct:1,hint:"I'd like = istiyorum (sipariş için)!"}},

{id:"e096",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:2,type:"mc",
 question:'Boşluğu doldurun:\n"He ___ bananas but he ___ oranges." (seviyor / sevmiyor)',
 options:["A) like / don't like","B) likes / doesn't like","C) likes / don't like","D) like / doesn't like"],
 correct:1,wrongFeedback:'"He" = 3.tekil → "likes" ve "doesn\'t like". He likes bananas but he doesn\'t like oranges.',
 hint:"He → likes / doesn't like. (not like/don't like)",
 simplified:{question:'"He" için olumsuz form hangisi?',options:["A) don't like","B) doesn't like"],correct:1,hint:"He → doesn't like!"}},

{id:"e097",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:2,type:"mc",
 question:'Okuma:\n"Ali likes pizza, hamburgers and ice cream. He doesn\'t like broccoli or carrots."\n\nAli doesn\'t like ___.',
 options:["A) pizza and ice cream","B) hamburgers","C) broccoli and carrots","D) juice"],
 correct:2,wrongFeedback:"Metinde 'doesn't like broccoli or carrots' yazıyor. Brokoli ve havuç sevmez.",
 hint:"Doesn't like = sevmiyor. Metinde ne yazıyor?",
 simplified:{question:"Metinde Ali'nin sevmediği şeyler neler?",options:["A) Pizza ve dondurma","B) Hamburger","C) Brokoli ve havuç","D) Meyve suyu"],correct:2,hint:"Metinde 'doesn't like broccoli or carrots'!"}},

{id:"e098",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:3,type:"mc",
 question:'Doğru soruyu bul:\n"___ Selin like chocolate?"\nCevap: "Yes, she does."',
 options:["A) Is","B) Do","C) Does","D) Did"],
 correct:2,wrongFeedback:'"Does Selin like...?" = Selin... sever mi? 3. tekil soru → Does. Cevap: Yes, she does.',
 hint:"Soru: She/He/It → Does. I/You/We/They → Do.",
 simplified:{question:"She için evet/hayır sorusu nasıl kurulur?",options:["A) Do she like?","B) Does she like?"],correct:1,hint:"She → Does she like? (Do she YANLIŞ)!"}},

{id:"e099",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:3,type:"mc",
 question:'Menü sorusu:\n"The menu: Soup 15₺, Pasta 45₺, Salad 25₺, Juice 10₺"\n"I\'d like soup and juice. How much is it?"',
 options:["A) 20₺","B) 25₺","C) 35₺","D) 55₺"],
 correct:1,wrongFeedback:"Soup 15₺ + Juice 10₺ = 25₺.",
 hint:"Soup=15, Juice=10. 15+10=?",
 simplified:{question:"15 + 10 = ?",options:["A) 20","B) 25","C) 30","D) 35"],correct:1,hint:"15+10=25₺!"}},

{id:"e100",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:3,type:"mc",
 question:'Hangisi yanlış cümledir?',
 options:["A) I like apples.","B) She likes pizza.","C) He don't like milk.","D) They don't like carrots."],
 correct:2,wrongFeedback:'"He don\'t like" YANLIŞ. He = 3.tekil → "doesn\'t like". He doesn\'t like milk.',
 hint:"He → doesn't (don't değil!). 3. tekil olumsuz = doesn't.",
 simplified:{question:'"He" için olumsuz hangisi?',options:["A) don't like","B) doesn't like"],correct:1,hint:"He → doesn't like (don't YANLIŞ)!"}},
];
const QBI2 = [
// ══ UNIT 1: CLASSROOM RULES – PDF tipine göre ══
// Kelime sıralama, "hangisi değildir", eşleştirme, diyalog

{id:"ex001",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:2,type:"mc",
 question:'Kelimeleri doğru sıraya koy:\n"I / may / go / out / ?"',
 options:["A) May I go out?","B) I may out go?","C) Go may I out?","D) Out may I go?"],
 correct:0,wrongFeedback:'"May I go out?" = İzin cümlesinin doğru sırası: May + I + fiil + nesne/yer + ?',
 hint:"İzin sorusu kalıbı: May I + fiil + ...?",
 simplified:{question:'"May I ___?" kalıbında boşluğa ne gelir?',options:["A) Fiil (go, come, join...)","B) İsim (book, pen...)"],correct:0,hint:"May I + fiil = izin sormak!"}},

{id:"ex002",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:2,type:"mc",
 question:'"May I join the game?"\nAşağıdakilerden hangisi bu sorunun DOĞRU cevabı DEĞİLDİR?',
 options:["A) Sure.","B) Of course.","C) Yes, you may.","D) Here you are."],
 correct:3,wrongFeedback:'"Here you are" = al, buyur. İzin cevabı değil. A, B, C hepsi "evet, olabilirsin" anlamında.',
 hint:'"Here you are" ne zaman kullanılır? Bir şey verirken!',
 simplified:{question:'"Here you are" ne zaman denir?',options:["A) İzin verirken","B) Bir şey uzatırken/verirken"],correct:1,hint:"Here you are = al, buyur (bir şey verince)!"}},

{id:"ex003",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:2,type:"mc",
 question:'Hangisi sınıf nesnesi (classroom object) DEĞİLDİR?',
 options:["A) Ruler","B) Eraser","C) Pencil case","D) Sofa"],
 correct:3,wrongFeedback:'"Sofa" = koltuk, ev eşyası. Ruler=cetvel, Eraser=silgi, Pencil case=kalemlik — hepsi sınıf nesnesi.',
 hint:"Sofa nerede bulunur? Sınıfta mı evde mi?",
 simplified:{question:'"Sofa" nerede bulunur?',options:["A) Sınıfta","B) Oturma odasında (evde)"],correct:1,hint:"Sofa = ev → sınıf nesnesi değil!"}},

{id:"ex004",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:2,type:"mc",
 question:'Boşlukları uygun şekilde doldurun:\n1. Turn ___ the lights. It\'s dark.\n2. Turn ___ the TV. It\'s bed time.',
 options:["A) on / off","B) off / on","C) on / on","D) off / off"],
 correct:0,wrongFeedback:"Karanlık → ışığı AÇ (turn on). Uyku vakti → TV'yi KAPAT (turn off).",
 hint:"Turn ON = aç. Turn OFF = kapat.",
 simplified:{question:"Işığı açmak için ne denir?",options:["A) Turn off","B) Turn on"],correct:1,hint:"Turn on = aç. Turn off = kapat!"}},

{id:"ex005",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:2,type:"mc",
 question:'"The pencil sharpener, please."\nBu cümle ile aynı anlamdaki ifade hangisidir?',
 options:["A) May I use the pencil sharpener?","B) Here you are, the pencil sharpener.","C) It\'s a pencil sharpener.","D) Where is the pencil sharpener?"],
 correct:0,wrongFeedback:'"The pencil sharpener, please" = Kalemtraşı verir misin? = May I have/take the pencil sharpener?',
 hint:'"Nesne + please" = o nesneyi ister misin kalıbı.',
 simplified:{question:"Birisi ruler please dediğinde ne istiyor?",options:["A) Cetveli göster","B) Cetveli ver (rica ediyor)"],correct:1,hint:"Nesne + please = o seyi istiyorum!"}},

{id:"ex006",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:2,type:"mc",
 question:'Eşleştirmelerden hangisi YANLIŞTIR?\nKomut → Türkçe',
 options:["A) Be quiet → Sessiz ol","B) Turn around → Etrafına bak","C) Repeat after me → Benden sonra tekrar et","D) Raise your hand → Elini kaldır"],
 correct:1,wrongFeedback:'"Turn around" = arkana dön / etrafında dön. "Etrafına bak" = Look around. B yanlış.',
 hint:'"Around" = etrafında/çevresinde. Turn around = dön(me hareketi).',
 simplified:{question:'"Turn around" ne demek?',options:["A) Etrafına bak","B) Dön (arkana)"],correct:1,hint:"Turn around = dön, arkan dön!"}},

{id:"ex007",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:3,type:"mc",
 question:'Aşağıdaki ifadelerden hangisi diğerlerinden FARKLIDIR?\n(İzin sorusu değil olanı bul)',
 options:["A) May I come in?","B) Can I go out?","C) May I turn on the lights?","D) Here you are."],
 correct:3,wrongFeedback:'"Here you are" izin sormaz — bir şey uzatırken kullanılır. A, B, C hepsi izin sorusu.',
 hint:"İzin soruları May I / Can I ile başlar.",
 simplified:{question:'"Here you are" izin sorusu mudur?',options:["A) Evet","B) Hayır — bir şey verirken kullanılır"],correct:1,hint:"Here you are = al buyur, izin sorusu değil!"}},

{id:"ex008",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:3,type:"mc",
 question:'Diyalogu doğru tamamla:\nStudent: May I go out?\nTeacher: _______\nStudent: May I go out?\nTeacher: Yes, you may.',
 options:["A) Of course.","B) Be quiet, please!","C) Say that again, please.","D) Please come in."],
 correct:2,wrongFeedback:'"Say that again, please" = Tekrar söyler misin? Öğrenci aynı soruyu tekrar soruyor, demek öğretmen duyamamış.',
 hint:"Öğrenci neden soruyu tekrarlıyor? Öğretmen ne demiş olabilir?",
 simplified:{question:'"Say that again" ne demek?',options:["A) Tekrar söyle","B) Sessiz ol","C) Dışarı çık","D) Buyur"],correct:0,hint:"Say that again = tekrar söyle = Repeat!"}},

{id:"ex009",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:3,type:"mc",
 question:'Hangisi okul kurallarına UYGUNDUR?',
 options:["A) You may eat and drink in the classroom.","B) You may run in the corridors.","C) You may not talk during the exam.","D) You may use your phone in class."],
 correct:2,wrongFeedback:"Sınav sırasında konuşmamak okul kuralıdır. A, B, D okul kurallarına aykırı.",
 hint:"Sınav sırasında konuşmak doğru mu yanlış mı?",
 simplified:{question:"Sınav sırasında konuşmak uygun mu?",options:["A) Evet, konuşabilirim","B) Hayır, konuşmamak gerekir"],correct:1,hint:"Sınavda sessiz ol = You may not talk!"}},

{id:"ex010",subject:"ingilizce",kazanim:401,kazanimName:"Classroom Rules",difficulty:3,type:"mc",
 question:'Eşleştirme:\nA. May I join? → 1. Here you are.\nB. Give me the book, please. → 2. Yes, you may.\nC. The eraser, please. → 3. Of course.\nHangisi YANLIŞTIR?',
 options:["A) A-2 doğru","B) B-1 doğru","C) C-3 doğru","D) A-3 doğru ve B-1 doğru, C-2 yanlış"],
 correct:2,wrongFeedback:'"The eraser, please" = silgiyi ver → cevap "Here you are" (al buyur). C-3 (Of course) yanlış eşleşme.',
 hint:'"Nesne + please" cevabı ne olmalı? Bir şey verirken ne denir?',
 simplified:{question:"Birisi senden bir şey istediğinde ne dersin?",options:["A) Of course (tabii ki)","B) Here you are (al buyur)"],correct:1,hint:"Nesne verirken = Here you are!"}},

// ══ UNIT 2: NATIONALITY – Gelişmiş sorular ══
{id:"ex011",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:2,type:"mc",
 question:'Diyalog eşleştirmesi:\nQuestion: "Where are you from?"\nAnswer: "___"\nHangisi DOĞRU yanıt değildir?',
 options:["A) I am from Turkey.","B) I am Turkish.","C) I am from Ankara.","D) I am from Turkish."],
 correct:3,wrongFeedback:'"I am from Turkish" YANLIŞ. "From" dan sonra ülke/şehir adı gelir, milliyet değil. "I am from Turkey" = doğru.',
 hint:'"From" + ülke adı. "From" + milliyet YANLIŞ.',
 simplified:{question:'"I am from ___" boşluğuna ne gelir?',options:["A) Turkish (milliyet)","B) Turkey (ülke adı)"],correct:1,hint:"From + ülke adı: I am from Turkey (Turkish değil)!"}},

{id:"ex012",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:2,type:"mc",
 question:'Okuma:\n"Hello! I am Carlos. I am from Spain. I am Spanish. I live in Madrid."\n\nAşağıdakilerden hangisi YANLIŞTIR?',
 options:["A) Carlos is from Spain.","B) Carlos is Spanish.","C) Carlos lives in Madrid.","D) Carlos is from Madrid, Italy."],
 correct:3,wrongFeedback:"Madrid İtalya'da değil, İspanya'dadır. A, B, C metne göre doğru.",
 hint:"Madrid hangi ülkededir?",
 simplified:{question:"Madrid hangi ülkenin şehridir?",options:["A) İtalya","B) İspanya"],correct:1,hint:"Madrid = İspanya = Spain!"}},

{id:"ex013",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:2,type:"mc",
 question:'Örüntüyü tamamla:\nTurkey-Turkish / France-French / Germany-___ / Italy-Italian',
 options:["A) Germanish","B) Germanian","C) German","D) Germanly"],
 correct:2,wrongFeedback:"Germany → German. Almanya → Alman. Diğerleri uydurma kelimelerdir.",
 hint:"Germany → German (İngilizce'de millet isimleri düzensizdir, kural yoktur).",
 simplified:{question:"Almanya İngilizce nedir?",options:["A) Germanland","B) Germany"],correct:1,hint:"Almanya = Germany → German (Alman)!"}},

{id:"ex014",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:3,type:"mc",
 question:'Diyalogu tamamla:\nTeacher: "Class, where is Yuki from?"\nStudent: "___ from Japan. ___ Japanese."\nDoğru şıkkı seç.',
 options:["A) He is / He is","B) She is / She is","C) They are / They are","D) We are / We are"],
 correct:1,wrongFeedback:"Yuki Japon kız ismi → She. She is from Japan. She is Japanese.",
 hint:"Yuki = Japon kız ismi → She.",
 simplified:{question:"Yuki kız mı erkek mi ismi?",options:["A) Erkek → He","B) Kız → She"],correct:1,hint:"Yuki = Japon kız ismi → She is!"}},

{id:"ex015",subject:"ingilizce",kazanim:402,kazanimName:"Nationality",difficulty:3,type:"mc",
 question:'Hangisinde HATA var?\nI. Tom is from England. He is English.\nII. Ana is from Spain. She is Spanishly.\nIII. Pierre is from France. He is French.\nIV. Yuki is from Japan. She is Japanese.',
 options:["A) I","B) II","C) III","D) IV"],
 correct:1,wrongFeedback:'"Spanishly" diye bir kelime yoktur. Spain → Spanish. II\'de hata var.',
 hint:'Spanishly diye bir kelime yok — Spain → Spanish!',
 simplified:{question:"İspanyol milliyet kelimesi nedir?",options:["A) Spanishly","B) Spanish"],correct:1,hint:"Spain → Spanish (Spanishly YANLIŞ)!"}},

// ══ UNIT 3: CARTOON CHARACTERS – Gelişmiş ══
{id:"ex016",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:2,type:"mc",
 question:'Hangisinde have/has DOĞRU kullanılmıştır?',
 options:["A) I has a red car.","B) She have long hair.","C) He has blue eyes.","D) They has big ears."],
 correct:2,wrongFeedback:'"He has" = doğru (3. tekil). I have, She has, They have. C doğru.',
 hint:"He/She/It → has. I/You/We/They → have.",
 simplified:{question:"He için have mi has mi?",options:["A) have","B) has"],correct:1,hint:"He → has!"}},

{id:"ex017",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:2,type:"mc",
 question:'Okuma:\n"Supercat is a cartoon character. She has a blue cape. She can fly and she can swim. She can\'t run fast."\n\nSupercat CANNOT ___.',
 options:["A) fly","B) swim","C) run fast","D) wear a cape"],
 correct:2,wrongFeedback:"Metinde 'She can't run fast' yazıyor. Hızlı koşamaz.",
 hint:"Cannot = can't. Metinde ne yapamıyor?",
 simplified:{question:"Metinde Supercat ne yapamıyor?",options:["A) Uçamıyor","B) Yüzemiyor","C) Hızlı koşamıyor","D) Yüzük takamıyor"],correct:2,hint:"Metinde 'can't run fast' yazıyor!"}},

{id:"ex018",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:2,type:"mc",
 question:'Boşlukları doldur:\n"Wondergirl ___ long red hair. She ___ fly but she ___ drive a car."',
 options:["A) has / can / can","B) has / can / can't","C) have / can / can't","D) has / can't / can"],
 correct:1,wrongFeedback:"Wondergirl = she → has. Uçabilir → can. Araba süremez → can't.",
 hint:"She → has. Uçabilir = can. Araba süremez = can't.",
 simplified:{question:"Wondergirl için has mı have mi kullanılır?",options:["A) have","B) has"],correct:1,hint:"She → has!"}},

{id:"ex019",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:3,type:"mc",
 question:'Diyalogu tamamla:\n"___ Spiderman climb walls?"\n"Yes, ___."\n',
 options:["A) Can / he can","B) Does / he does","C) Is / he is","D) Has / he has"],
 correct:0,wrongFeedback:"Yetenek sorusu: Can + özne + fiil? Cevap: Yes, he can.",
 hint:"Yetenek sorusu = Can + ...? Cevap = Yes, he/she/it can.",
 simplified:{question:"Yetenek sorusu nasıl kurulur?",options:["A) Can + özne + fiil?","B) Does + özne + fiil?"],correct:0,hint:"Yetenek = Can Spiderman...?"}},

{id:"ex020",subject:"ingilizce",kazanim:403,kazanimName:"Cartoon Characters",difficulty:3,type:"mc",
 question:'İki karakter karşılaştırması:\n"Flash has short blonde hair. He can run very fast. He can\'t fly.\nAquaman has dark hair. He can swim very fast. He can\'t fly either."\n\nİki karakterin ORTAK özelliği nedir?',
 options:["A) They can fly.","B) They can run fast.","C) They can't fly.","D) They have blonde hair."],
 correct:2,wrongFeedback:"Her ikisi de uçamaz: Flash can't fly + Aquaman can't fly. 'Either' = de/da (olumsuzda).",
 hint:"Her ikisi de ne yapamıyor? 'can't fly either' = o da uçamaz.",
 simplified:{question:"İki karakterin ortak özelliği ne?",options:["A) İkisi de uçabilir","B) İkisi de uçamaz"],correct:1,hint:"Flash can't fly + Aquaman can't fly = ikisi de uçamaz!"}},

// ══ UNIT 4: FREE TIME – Gelişmiş ══
{id:"ex021",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:2,type:"mc",
 question:'Hangisinde like + Ving DOĞRU kullanılmıştır?',
 options:["A) She like to play tennis.","B) She likes play tennis.","C) She likes playing tennis.","D) She likes to playing tennis."],
 correct:2,wrongFeedback:'"She likes playing" = doğru. Like + Ving kuralı. "She likes to play" da doğru ama seçeneklerde yok.',
 hint:"Like + Ving = She likes playing. Veya Like + to fiil = She likes to play.",
 simplified:{question:'"She likes ___ing" kalıbında boşluğa ne gelir?',options:["A) Fiil + ing (playing, reading...)","B) Yalnızca isim (book, ball...)"],correct:0,hint:"Like + Ving → She likes playing!"}},

{id:"ex022",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:2,type:"mc",
 question:'Diyalogu tamamla:\n"What does Ali like doing?"\n"___"\n',
 options:["A) He likes playing football.","B) He like playing football.","C) She likes playing football.","D) Ali like football."],
 correct:0,wrongFeedback:'"He likes" = doğru (Ali = erkek = he, 3. tekil → likes).',
 hint:"Ali = erkek → he. 3. tekil → likes.",
 simplified:{question:"Ali erkek mi? Hangi zamir kullanılır?",options:["A) She","B) He"],correct:1,hint:"Ali = erkek = He likes!"}},

{id:"ex023",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:3,type:"mc",
 question:'Okuma:\n"Berk and Selin are friends. Berk likes playing video games and cycling. He doesn\'t like swimming. Selin likes swimming and drawing. She doesn\'t like cycling."\n\nHangisi DOĞRUDUR?',
 options:["A) Berk likes swimming.","B) Selin likes cycling.","C) Both Berk and Selin like cycling.","D) Berk likes cycling but Selin doesn't."],
 correct:3,wrongFeedback:"Berk cycling sever (likes cycling). Selin cycling sevmez (doesn't like cycling). D doğru.",
 hint:"Berk → likes cycling ✓. Selin → doesn't like cycling ✓.",
 simplified:{question:"Metinde Selin cycling'i sever mi?",options:["A) Evet","B) Hayır"],correct:1,hint:"Selin doesn't like cycling = Selin cycling sevmez!"}},

{id:"ex024",subject:"ingilizce",kazanim:404,kazanimName:"Free Time",difficulty:3,type:"mc",
 question:'"What do you like doing at the weekend?"\nAşağıdakilerden hangisi YANLIŞ cevaptır?',
 options:["A) I like reading books.","B) I likes watching movies.","C) I like playing basketball.","D) I don't like cooking."],
 correct:1,wrongFeedback:'"I likes" YANLIŞ. I → like (s eki almaz). "I likes" diye bir ifade yoktur.',
 hint:"I + like (I likes YANLIŞ).",
 simplified:{question:'"I" için like mi likes mi?',options:["A) likes","B) like"],correct:1,hint:"I → like (s yok)!"}},

// ══ UNIT 5: MY DAY – Gelişmiş ══
{id:"ex025",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:2,type:"mc",
 question:'Boşluğu doldurun:\n"My father ___ to work at 8 o\'clock every day."',
 options:["A) go","B) goes","C) going","D) gone"],
 correct:1,wrongFeedback:'"My father" = 3. tekil şahıs → goes. Simple Present: He/She/It → go + es/s.',
 hint:"My father = he = 3. tekil → goes.",
 simplified:{question:'"He" için go mu goes mi?',options:["A) go","B) goes"],correct:1,hint:"He → goes (3. tekil şahıs s/es eki)!"}},

{id:"ex026",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:2,type:"mc",
 question:'Günlük rutini doğru sıraya koy:\n1. Do homework\n2. Wake up\n3. Have dinner\n4. Go to school\n5. Have breakfast',
 options:["A) 2-5-4-1-3","B) 1-2-3-4-5","C) 5-2-4-1-3","D) 2-4-5-1-3"],
 correct:0,wrongFeedback:"Sabahtan akşama: Uyan(2) → Kahvaltı(5) → Okul(4) → Ödev(1) → Akşam yemeği(3). 2-5-4-1-3.",
 hint:"Sabah önce uyandın, en son akşam yemeği.",
 simplified:{question:"Sabahleyin ilk ne yapılır?",options:["A) Akşam yemeği","B) Uyanmak"],correct:1,hint:"İlk adım: Wake up (uyanmak)!"}},

{id:"ex027",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:2,type:"mc",
 question:'"What time does Ayşe wake up?"\nDoğru cevap hangisi?',
 options:["A) She wake up at 7.","B) She wakes up at 7.","C) She wakes up in 7.","D) She wake ups at 7."],
 correct:1,wrongFeedback:'"She wakes up at 7." doğru. Ayşe = she = 3. tekil → wakes (s eki). At + saat.',
 hint:"She → wakes (s eki). Saat için → at.",
 simplified:{question:'"She" için wake mu wakes mi?',options:["A) wake","B) wakes"],correct:1,hint:"She → wakes (3. tekil s eki)!"}},

{id:"ex028",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:3,type:"mc",
 question:'Okuma:\n"Tom wakes up at 6:30. He brushes his teeth and has breakfast at 7:00. He goes to school at 7:45. He comes home at 4:00 and does his homework. He goes to bed at 10:00."\n\nHangisi YANLIŞTIR?',
 options:["A) Tom wakes up at half past six.","B) Tom has breakfast at seven o'clock.","C) Tom goes to school at quarter past seven.","D) Tom goes to bed at ten o'clock."],
 correct:2,wrongFeedback:"Tom okula 7:45'te gidiyor. 7:45 = quarter to eight (sekize çeyrek var), quarter past seven değil (7:15).",
 hint:"7:45 = quarter to eight. Quarter past seven = 7:15.",
 simplified:{question:"7:45 nasıl söylenir?",options:["A) Quarter past seven (7:15)","B) Quarter to eight (sekize çeyrek var = 7:45)"],correct:1,hint:"7:45 = quarter to eight!"}},

{id:"ex029",subject:"ingilizce",kazanim:405,kazanimName:"My Day",difficulty:3,type:"mc",
 question:'Negatif cümle yap:\n"She goes to school at 8." → "___ go to school at 8."',
 options:["A) She don't","B) She doesn't","C) She isn't","D) She not"],
 correct:1,wrongFeedback:'"She doesn\'t go" = o ... gitmiyor. 3. tekil olumsuz = doesn\'t. (don\'t değil!)',
 hint:"She = 3. tekil → doesn't (don't değil).",
 simplified:{question:'"She" için olumsuz yardımcı fiil hangisi?',options:["A) don't","B) doesn't"],correct:1,hint:"She → doesn't!"}},

// ══ UNIT 6: FUN WITH SCIENCE – Gelişmiş ══
{id:"ex030",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:2,type:"mc",
 question:'Doğru eşleştirme hangisidir?\nThe pencil is ___ the book. (kitabın üstünde)',
 options:["A) in","B) under","C) on","D) next to"],
 correct:2,wrongFeedback:'"On" = üstünde (temas halinde). Kalem kitabın üstünde = on the book.',
 hint:"Üstünde (temas) = on. Üzerinde (havada) = above.",
 simplified:{question:"Masanın üstündeki kitap için hangi edat?",options:["A) in","B) under","C) on","D) behind"],correct:2,hint:"Üstünde = on!"}},

{id:"ex031",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:2,type:"mc",
 question:'Talimatı sıraya koy:\n1. Shake the bottle.\n2. Add sugar.\n3. Put water in the bottle.\n4. Close the bottle.',
 options:["A) 3-2-4-1","B) 1-2-3-4","C) 2-3-1-4","D) 3-4-2-1"],
 correct:0,wrongFeedback:"Önce suyu koy (3) → şeker ekle (2) → şişeyi kapat (4) → salla (1). 3-2-4-1.",
 hint:"Mantıklı sıra: koy → ekle → kapat → salla.",
 simplified:{question:"Şişeyi sallamadan önce ne yapılmalı?",options:["A) Şişeyi kapatmak","B) Şişeyi açmak"],correct:0,hint:"Önce kapat (close), sonra salla (shake)!"}},

{id:"ex032",subject:"ingilizce",kazanim:406,kazanimName:"Fun with Science",difficulty:3,type:"mc",
 question:'Okuma:\n"In the lab: The red book is on the shelf. The pencil is next to the book. The scissors are under the desk. The ruler is in the box."\n\nHangisi YANLIŞTIR?',
 options:["A) The red book is on the shelf.","B) The pencil is next to the book.","C) The scissors are on the desk.","D) The ruler is in the box."],
 correct:2,wrongFeedback:"Metinde 'The scissors are under the desk' yazıyor, on the desk değil. C yanlış.",
 hint:"'Under' = altında. 'On' = üstünde. Fark var!",
 simplified:{question:"Metinde makas nerededir?",options:["A) Masanın üstünde (on)","B) Masanın altında (under)"],correct:1,hint:"Under the desk = masanın altında!"}},

// ══ UNIT 7: JOBS – Gelişmiş ══
{id:"ex033",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:2,type:"mc",
 question:'Meslek + çalışma yeri eşleştirmesi:\nHangisi YANLIŞTIR?',
 options:["A) Doctor – hospital","B) Teacher – school","C) Chef – airport","D) Nurse – hospital"],
 correct:2,wrongFeedback:"Chef (aşçı) bir restoranda çalışır, havalimanında değil. Pilot havalimanında çalışır.",
 hint:"Chef nerede çalışır? Restoranda mı havalimanında mı?",
 simplified:{question:"Chef (aşçı) nerede çalışır?",options:["A) Airport (havalimanı)","B) Restaurant (restoran)"],correct:1,hint:"Chef = aşçı → restaurant!"}},

{id:"ex034",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:2,type:"mc",
 question:'Diyalogu tamamla:\n"What does she do?"\n"___ a vet. She ___ animals."',
 options:["A) She is / treats","B) She is / eats","C) She has / treats","D) She does / work"],
 correct:0,wrongFeedback:'"She is a vet" = o veterinerdir. "She treats animals" = hayvanlara bakar.',
 hint:"Meslek için: She is a + meslek. Vet = veteriner.",
 simplified:{question:'"Vet" ne demek?',options:["A) Pilot","B) Veteriner"],correct:1,hint:"Vet = veteriner (hayvan doktoru)!"}},

{id:"ex035",subject:"ingilizce",kazanim:407,kazanimName:"Jobs",difficulty:3,type:"mc",
 question:'Okuma:\n"My mum is a nurse. She works in City Hospital. She helps sick people. She likes her job because she helps others."\n\nHangisi metnin ANA FİKRİDİR?',
 options:["A) City Hospital is a big hospital.","B) The writer's mum is a nurse who helps sick people.","C) Nurses don't like their job.","D) The writer wants to be a nurse."],
 correct:1,wrongFeedback:"Ana fikir: Annesinin hemşire olduğu ve hasta insanlara yardım ettiği. B en kapsamlı.",
 hint:"Ana fikir = metnin en önemli mesajı nedir?",
 simplified:{question:"Bu metnin konusu nedir?",options:["A) Hastaneler","B) Annesinin hemşirelik mesleği"],correct:1,hint:"Metin boyunca annesinin hemşireliğinden bahsediliyor!"}},

// ══ UNIT 8: MY CLOTHES – Gelişmiş ══
{id:"ex036",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:2,type:"mc",
 question:'Mevsim → kıyafet eşleştirmesi:\nWinter (Kış) → ___',
 options:["A) T-shirt, shorts and sandals","B) Dress and sunglasses","C) Coat, boots, scarf and gloves","D) Light jacket and jeans"],
 correct:2,wrongFeedback:"Kış = soğuk → palto, çizme, atkı, eldiven gerekir.",
 hint:"Winter = kış = soğuk. Hangi kıyafetler sıcak tutar?",
 simplified:{question:"Kışın ne giyersin?",options:["A) T-shirt ve şort","B) Palto ve atkı"],correct:1,hint:"Kış = soğuk → palto, atkı, eldiven!"}},

{id:"ex037",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:2,type:"mc",
 question:'Boşluğu doldurun:\n"It\'s raining. You should ___ your raincoat and ___ your umbrella."',
 options:["A) put on / take","B) take off / put","C) wear / is","D) open / close"],
 correct:0,wrongFeedback:'"Put on your raincoat" = yağmurluk giy. "Take your umbrella" = şemsiyeni al.',
 hint:"Put on = giy. Take = al (götür).",
 simplified:{question:'"Put on" ne demek?',options:["A) Çıkarmak","B) Giymek"],correct:1,hint:"Put on = giy!"}},

{id:"ex038",subject:"ingilizce",kazanim:408,kazanimName:"My Clothes",difficulty:3,type:"mc",
 question:'Okuma:\n"Ali is wearing a white shirt, black trousers and brown shoes. He also has a blue tie."\n\nAli is NOT wearing ___.',
 options:["A) a shirt","B) trousers","C) a jacket","D) shoes"],
 correct:2,wrongFeedback:"Metinde jacket geçmiyor. Shirt, trousers, shoes ve tie var ama jacket yok.",
 hint:"Metinde hangi kıyafet bahsedilmiyor?",
 simplified:{question:"Metinde Ali'nin kıyafetleri: shirt, trousers, shoes ve tie. Hangisi YOK?",options:["A) Shirt","B) Jacket"],correct:1,hint:"Jacket metinde geçmiyor = Ali jacket giymemiş!"}},

// ══ UNIT 9: MY FRIENDS – Gelişmiş ══
{id:"ex039",subject:"ingilizce",kazanim:409,kazanimName:"My Friends",difficulty:2,type:"mc",
 question:'Doğru cümleyi seç:\nDerya\'yı tanımla: Kısa boylu, uzun kıvırcık saçlı, mavi gözlü.',
 options:["A) Derya is tall. She has straight hair and blue eyes.","B) Derya is short. She has long curly hair and blue eyes.","C) Derya is short. She has long straight hair and green eyes.","D) Derya is tall. She has curly hair and brown eyes."],
 correct:1,wrongFeedback:"Kısa = short. Uzun kıvırcık saç = long curly hair. Mavi gözler = blue eyes. B doğru.",
 hint:"Short=kısa, long curly hair=uzun kıvırcık saç, blue eyes=mavi gözler.",
 simplified:{question:'"Curly hair" ne demek?',options:["A) Düz saç","B) Kıvırcık saç"],correct:1,hint:"Curly = kıvırcık!"}},

{id:"ex040",subject:"ingilizce",kazanim:409,kazanimName:"My Friends",difficulty:3,type:"mc",
 question:'Okuma:\n"My best friend is Ceren. She is tall and thin. She has long straight black hair. She has brown eyes. She likes playing volleyball."\n\nHangisi ÇIKARILAMAZ?',
 options:["A) Ceren is tall.","B) Ceren has black hair.","C) Ceren is good at volleyball.","D) Ceren likes playing volleyball."],
 correct:2,wrongFeedback:"Good at volleyball = voleybolda iyi. Metinde yalnizca likes playing yaziyor, iyi oldugunu soylemiyor.",
 hint:"Sevmek ≠ iyi olmak. Metinde ne yazıyor?",
 simplified:{question:"Metinde Ceren voleybolda iyi olduğu yazıyor mu?",options:["A) Evet","B) Hayır, sadece sevdiği yazıyor"],correct:1,hint:"Likes ≠ good at. Sevmek iyi olmak değildir!"}},

// ══ UNIT 10: FOOD & DRINKS – Gelişmiş ══
{id:"ex041",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:2,type:"mc",
 question:'Diyalogu tamamla:\nWaiter: "Would you like some dessert?"\nCustomer: "Yes, ___ a piece of chocolate cake, please."\n',
 options:["A) I like","B) I'd like","C) I wants","D) Give me"],
 correct:1,wrongFeedback:'"I\'d like" = istiyorum (kibarca). Restoranda sipariş için kullanılır.',
 hint:"Kibarca sipariş = I'd like (would like kısa hali).",
 simplified:{question:"Kibarca sipariş vermek için ne denir?",options:["A) I like","B) I'd like"],correct:1,hint:"I'd like = would like = kibarca istiyorum!"}},

{id:"ex042",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:2,type:"mc",
 question:'Hangisinde likes/doesn\'t like YANLIŞ kullanılmıştır?',
 options:["A) She likes apples.","B) He doesn't like broccoli.","C) They likes pizza.","D) She doesn't like fish."],
 correct:2,wrongFeedback:'"They likes" YANLIŞ. They → like (not likes). They like pizza. C yanlış.',
 hint:"They/We/I/You → like. He/She/It → likes.",
 simplified:{question:'"They" için like mi likes mi?',options:["A) likes","B) like"],correct:1,hint:"They → like (s yok)!"}},

{id:"ex043",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:3,type:"mc",
 question:'Okuma:\n"Selin\'s favourite food is pizza. She also likes pasta and salad. She doesn\'t like meat or fish. Her favourite drink is orange juice."\n\nAşağıdakilerden hangisi DOĞRUDUR?',
 options:["A) Selin likes meat.","B) Selin's favourite drink is milk.","C) Selin doesn't like fish.","D) Selin doesn't like pasta."],
 correct:2,wrongFeedback:"Metinde 'She doesn't like meat or fish' yazıyor. C doğru.",
 hint:"or = veya. 'doesn't like meat or fish' = et de balık da sevmez.",
 simplified:{question:"Metinde Selin balık sever mi?",options:["A) Evet","B) Hayır"],correct:1,hint:"doesn't like fish = balık sevmez!"}},

{id:"ex044",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:3,type:"mc",
 question:'Diyalog tamamlama:\nWaiter: "What would you like to drink?"\nAli: "I\'d like orange juice, please."\nWaiter: "Anything else?"\nAli: "___."\nWaiter: "Of course. Here you are."\n',
 options:["A) No, thank you.","B) Yes, a glass of water, please.","C) The bill, please.","D) I don't like water."],
 correct:1,wrongFeedback:"'Anything else?' = başka bir şey? Ali su istiyor. B mantıklı devam.",
 hint:"'Anything else?' = başka? → Evet, bir şey daha isteyebilir.",
 simplified:{question:'"Anything else?" ne demek?',options:["A) Ne içmek istersin?","B) Başka bir şey ister misin?"],correct:1,hint:"Anything else = başka bir şey?"}},

{id:"ex045",subject:"ingilizce",kazanim:410,kazanimName:"Food and Drinks",difficulty:3,type:"mc",
 question:'Doğru soru-cevap eşleştirmesi:\n"Does she like chocolate?"\n___',
 options:["A) Yes, she likes.","B) Yes, she do.","C) Yes, she does.","D) Yes, she is."],
 correct:2,wrongFeedback:'"Does she...?" sorusuna "Yes, she does." ile cevap verilir. (Yes, she likes/do/is yanlış)',
 hint:"Does + özne + ...? → Yes, özne + does.",
 simplified:{question:'"Does she like?" sorusuna nasıl cevap verilir?',options:["A) Yes, she do.","B) Yes, she does."],correct:1,hint:"Does ile sorulan → does ile cevap!"}},
];
const QB = [...QBT, ...QBM, ...QBX, ...QBF, ...QBS, ...QBI, ...QBI2];
...
const KAZ_I={401:"Classroom Rules",402:"Nationality",403:"Cartoon Characters",404:"Free Time",405:"My Day",406:"Fun with Science",407:"Jobs",408:"My Clothes",409:"My Friends",410:"Food and Drinks"};
const KAZ_INFO={...KAZ_T,...KAZ_M,...KAZ_I};
const DIFF_LABEL={1:"⭐ Kolay",2:"⭐⭐ Orta",3:"⭐⭐⭐ Zor"};
const DIFF_COLOR={1:"#16a34a",2:"#d97706",3:"#dc2626"};
const SUBJ_COLOR={turkce:"#b91c1c",matematik:"#1d4ed8",fen:"#16a34a",sosyal:"#d97706",ingilizce:"#7c3aed"};
const SUBJ_LABEL={turkce:"📖 Türkçe",matematik:"🔢 Matematik",fen:"🔬 Fen Bilimleri",sosyal:"🌍 Sosyal Bilgiler",ingilizce:"🇬🇧 İngilizce"};
...
export default function App(){
  ...
  const[levels,setLevels]=useState(()=>{const l={};for(let i=1;i<=12;i++)l[i]=1;for(let i=101;i<=110;i++)l[i]=1;for(let i=201;i<=210;i++)l[i]=1;for(let i=301;i<=310;i++)l[i]=1;for(let i=401;i<=410;i++)l[i]=1;return l;});
  const[used,setUsed]=useState(new Set());
  const[stats,setStats]=useState({c:0,t:0,wrong:0});
  const[streak,setStreak]=useState(0);
  const[showStats,setShowStats]=useState(false);
  const[history,setHistory]=useState([]); // [{q, sel, wasCorrect, simplified}]
  const[historyIdx,setHistoryIdx]=useState(null);
  const[showJump,setShowJump]=useState(false);
  const[jumpVal,setJumpVal]=useState("");
  // Retry kuyruğu: yanlış yapılan sorular 3-5 soru sonra tekrar çıkar
  const[retryQueue,setRetryQueue]=useState([]); // [{q, dueAt}]
  const[questionCount,setQuestionCount]=useState(0); // toplam yüklenen soru sayısı
  const[isRetry,setIsRetry]=useState(false);
  // Zamanlayıcı
  const[timerSec,setTimerSec]=useState(0);
  const[timerActive,setTimerActive]=useState(false);
  const timerRef=useRef(null);
  // Konu bazlı istatistik: {kazanimId: {c, t}}
  const[kazStats,setKazStats]=useState({});
  // Per-subject progress: {subj: {used, stats, levels, questionCount, retryQueue, kazStats, timerSec}}
  ...
  const totalInMode=mode?QB.filter(q=>mode==="karisik"||q.subject===mode).length:QB.length;
  const solvedInMode=mode?[...used].filter(id=>{const qo=QB.find(x=>x.id===id);return qo&&(mode==="karisik"||qo.subject===mode);}).length:used.size;
  const remaining=totalInMode-solvedInMode;
  const hasProgress=used.size>0;
  const reviewEntry=historyIdx!==null&&history[historyIdx]?history[historyIdx]:null;
  ...
  function saveProgress(m){
    if(!m||m==="karisik")return;
    setSubjectProgress(prev=>({...prev,[m]:{
      used:new Set([...used]),
      stats:{...stats},
      levels:{...levels},
      questionCount,
  ...
  function startFresh(m){
    const l=(()=>{const r={};for(let i=1;i<=12;i++)r[i]=1;for(let i=101;i<=110;i++)r[i]=1;for(let i=201;i<=210;i++)r[i]=1;for(let i=301;i<=310;i++)r[i]=1;for(let i=401;i<=410;i++)r[i]=1;return r;})();
    setMode(m);setUsed(new Set());setLevels(l);setStats({c:0,t:0,wrong:0});
    setStreak(0);setHistory([]);setHistoryIdx(null);setRetryQueue([]);setQuestionCount(0);
    setTimerSec(0);setTimerActive(true);setKazStats({});
    // subjectProgress'ten o dersi sil
    setSubjectProgress(prev=>{const n={...prev};delete n[m];return n;});
    loadNextWith(m,new Set(),l,0,[]);
  }
  function continueSubject(m){
    if(m==="karisik"){startFresh(m);return;}
    const sp=subjectProgress[m];
    if(!sp){startFresh(m);return;}
    setMode(m);
    setUsed(new Set([...sp.used]));
    setLevels({...sp.levels});
    setStats({...sp.stats});
    setStreak(0);
    setHistory([]);setHistoryIdx(null);
    setRetryQueue([...sp.retryQueue]);
    setQuestionCount(sp.questionCount);
    setTimerSec(sp.timerSec);
    setTimerActive(true);
    setKazStats({...sp.kazStats});
    loadNextWith(m,new Set([...sp.used]),sp.levels,sp.questionCount,sp.retryQueue);
  }
  function startMode(m){startFresh(m);}
  function continueMode(){setHistoryIdx(null);setTimerActive(true);if(mode)loadNext(mode);else setScreen("intro");}
  function loadNextWith(m,usedSet,lvls,cnt,rQueue){
    // Retry kuyruğundan sıra geldi mi?
    const dueRetry=rQueue.find(r=>r.dueAt<=cnt);
    if(dueRetry){
      setRetryQueue(prev=>prev.filter(r=>r.dueAt!==dueRetry.dueAt||r.q.id!==dueRetry.q.id));
      setIsRetry(true);
      setQ(dueRetry.q);setSel(null);setSimplified(false);setHistoryIdx(null);setScreen("question");
      return;
    }
    const nq=pickQ(lvls,usedSet,m);
    if(!nq&&!rQueue.length){setScreen("done");return;}
    if(!nq){setScreen("done");return;}
    setIsRetry(false);
    setQ(nq);setSel(null);setSimplified(false);setHistoryIdx(null);setScreen("question");
  }
  function loadNext(m,newCount){
    const curMode=m||mode;
    const cnt=newCount!==undefined?newCount:questionCount;
    loadNextWith(curMode,used,levels,cnt,retryQueue);
  }
  function handle(idx){
    if(sel!==null)return;
    setSel(idx);
    ...
    if(!isRetry)setUsed(p=>new Set([...p,q.id]));
    setStats(s=>({c:s.c+(ok?1:0),t:s.t+1,wrong:s.wrong+(ok?0:1)}));
    setHistory(h=>[...h,{q,sel:idx,wasCorrect:ok,simplified}]);
    setKazStats(ks=>({...ks,[q.kazanim]:{c:(ks[q.kazanim]?.c||0)+(ok?1:0),t:(ks[q.kazanim]?.t||0)+1}}));
    const newCount=questionCount+1;
    setQuestionCount(newCount);
    if(!ok&&!isRetry){
      const dueAt=newCount+(3+Math.floor(Math.random()*3)); // 3-5 soru sonra
      setRetryQueue(prev=>[...prev,{q,dueAt}]);
    }
  ...
  function handleMatch(ok){
    if(!isRetry)setUsed(p=>new Set([...p,q.id]));
    setStats(s=>({c:s.c+(ok?1:0),t:s.t+1,wrong:s.wrong+(ok?0:1)}));
    setHistory(h=>[...h,{q,sel:ok?q.correct:-1,wasCorrect:ok,simplified}]);
    setKazStats(ks=>({...ks,[q.kazanim]:{c:(ks[q.kazanim]?.c||0)+(ok?1:0),t:(ks[q.kazanim]?.t||0)+1}}));
    const newCountM=questionCount+1; setQuestionCount(newCountM);
    if(!ok&&!isRetry){const dueAt=newCountM+(3+Math.floor(Math.random()*3));setRetryQueue(prev=>[...prev,{q,dueAt}]);}
  ...
  function jumpToQuestion(n){
    const pool=QB.filter(x=>mode==="karisik"||x.subject===mode);
    const idx=parseInt(n)-1;
    if(isNaN(idx)||idx<0||idx>=pool.length)return;
    const target=pool[idx];
    // Check if already in history
    const histEntry=history.findIndex(h=>h.q.id===target.id);
    if(histEntry>=0){
      setHistoryIdx(histEntry);
      setScreen("review");
    } else {
      // Load as active question
      setQ(target);setSel(null);setSimplified(false);setHistoryIdx(null);setScreen("question");
    }
  ...
  function goForward(){
    ...
    if(historyIdx>=history.length-1){setHistoryIdx(null);setSel(null);setSimplified(false);setScreen("question");}
    else setHistoryIdx(historyIdx+1);
  }
  function resetAll(m){startFresh(m);}
  function fullReset(){
    const l=(()=>{const r={};for(let i=1;i<=12;i++)r[i]=1;for(let i=101;i<=110;i++)r[i]=1;for(let i=201;i<=210;i++)r[i]=1;for(let i=301;i<=310;i++)r[i]=1;for(let i=401;i<=410;i++)r[i]=1;return r;})();
    setUsed(new Set());setLevels(l);setStats({c:0,t:0,wrong:0});setStreak(0);
    setHistory([]);setHistoryIdx(null);setRetryQueue([]);setQuestionCount(0);
    setTimerSec(0);setTimerActive(false);setKazStats({});setSubjectProgress({});
    setMode(null);setScreen("intro");setShowStats(false);
  }
  ...
  // ── SHARED: Header butonları ──
  const HomeBtn=()=>(
    <div style={{display:"flex",gap:6,alignItems:"center"}}>
      <span style={{background:"rgba(0,0,0,.2)",borderRadius:8,padding:"5px 9px",
        color:"#fff",fontSize:12,fontFamily:"monospace",fontWeight:"bold",minWidth:42,textAlign:"center"}}>
        ⏱ {fmtTime(timerSec)}
      </span>
      {history.length>0&&(
        <button onClick={goBack} style={{background:"rgba(255,255,255,.2)",border:"none",borderRadius:8,
          padding:"5px 9px",color:"#fff",fontSize:12,cursor:"pointer",fontFamily:"inherit",fontWeight:"bold"}}>
          ←
        </button>
      )}
      <button onClick={goHome} style={{background:"rgba(255,255,255,.2)",border:"none",borderRadius:8,
        padding:"5px 9px",color:"#fff",fontSize:12,cursor:"pointer",fontFamily:"inherit",fontWeight:"bold"}}>
        🏠
      </button>
    </div>
  ...
  if(showStats) return(
    <div style={S.app}>
      <div style={{...S.hdr("#1a1a2e"),display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 16px"}}>
        <p style={{...S.hdrT,margin:0}}>📊 İstatistikler</p>
        <button onClick={()=>setShowStats(false)} style={{background:"rgba(255,255,255,.2)",border:"none",borderRadius:8,
          padding:"5px 10px",color:"#fff",fontSize:12,cursor:"pointer",fontFamily:"inherit"}}>← Geri</button>
      </div>
      <div style={S.wrap}>
        <div style={S.card}>
          <h3 style={{margin:"0 0 14px",color:"#1e293b",textAlign:"center"}}>Genel Durum</h3>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14}}>
            {[
              {label:"Çözülen",val:stats.t,icon:"📝",bg:"#eff6ff",c:"#1d4ed8"},
              {label:"Doğru",val:stats.c,icon:"✅",bg:"#f0fdf4",c:"#16a34a"},
              {label:"Yanlış",val:stats.wrong,icon:"❌",bg:"#fef2f2",c:"#dc2626"},
              {label:"Kalan",val:remaining,icon:"📚",bg:"#fefce8",c:"#d97706"},
            ].map(({label,val,icon,bg,c})=>(
              <div key={label} style={{background:bg,borderRadius:12,padding:"12px",textAlign:"center",border:`1px solid ${c}33`}}>
                <div style={{fontSize:26}}>{icon}</div>
                <div style={{fontSize:22,fontWeight:"bold",color:c}}>{val}</div>
          ...
          {stats.t>0&&(
            <>
              <div style={{display:"flex",justifyContent:"space-between",fontSize:12,color:"#6b7280",marginBottom:4}}>
                <span>Başarı Oranı</span><span style={{fontWeight:"bold",color:pct>=70?"#16a34a":pct>=50?"#d97706":"#dc2626"}}>%{pct}</span>
              </div>
              <div style={S.pbar}><div style={S.pbarFill(pct,pct>=70?"#16a34a":pct>=50?"#d97706":"#dc2626")}/></div>
              <div style={{marginTop:10,display:"flex",gap:8}}>
                <div style={{background:"#f0f9ff",borderRadius:10,padding:"8px 12px",flex:1,fontSize:12}}>
                  <span style={{color:"#6b7280"}}>⏱ Süre</span><br/>
                  <b style={{fontSize:16,fontFamily:"monospace"}}>{fmtTime(timerSec)}</b>
                </div>
                {retryQueue.length>0&&(
                  <div style={{background:"#fef3c7",borderRadius:10,padding:"8px 12px",flex:1,fontSize:12,border:"1px solid #fcd34d"}}>
                    <span style={{color:"#92400e"}}>🔁 Tekrar</span><br/>
                    <b style={{fontSize:16,color:"#d97706"}}>{retryQueue.length} soru</b>
                  </div>
                )}
              </div>
              <div style={{marginTop:10,padding:"8px 12px",background:"#f8fafc",borderRadius:10,fontSize:12,color:"#374151"}}>
                <b>Aktif Ders:</b> {mode?SUBJ_LABEL[mode]||"🎲 Karışık":"—"}<br/>
                <b>Bu derste:</b> {solvedInMode}/{totalInMode} çözüldü
                {streak>=2&&<> · <b>🔥{streak}</b></>}
              </div>
              {Object.keys(subjectProgress).length>0&&(
                <div style={{marginTop:10}}>
                  <div style={{fontSize:11,color:"#6b7280",marginBottom:6,fontWeight:"bold"}}>Tüm Dersler</div>
                  {[
                    {subj:"turkce",label:"📖 Türkçe",color:"#b91c1c"},
                    {subj:"matematik",label:"🔢 Matematik",color:"#1d4ed8"},
                    {subj:"fen",label:"🔬 Fen",color:"#16a34a"},
                    {subj:"sosyal",label:"🌍 Sosyal",color:"#d97706"},
                    {subj:"ingilizce",label:"🇬🇧 İngilizce",color:"#7c3aed"},
                  ].map(({subj,label,color})=>{
                    const sp=subjectProgress[subj]||(mode===subj?{stats:{...stats},used:new Set([...used]),timerSec}:null);
                    if(!sp)return null;
                    const t=QB.filter(x=>x.subject===subj).length;
                    const d=sp.used?[...sp.used].length:0;
                    const p=t?Math.round(d/t*100):0;
                    const st=sp.stats||stats;
                    return(
                      <div key={subj} style={{marginBottom:8}}>
                        <div style={{display:"flex",justifyContent:"space-between",fontSize:11,marginBottom:3}}>
                          <span style={{color,fontWeight:"bold"}}>{label}</span>
                          <span style={{color:"#6b7280"}}>{d}/{t} · ✅{st.c} ❌{st.wrong} · %{p}</span>
                        </div>
          ...
          {Object.keys(kazStats).length>0&&(
            <div style={{marginTop:14}}>
              <div style={{fontSize:12,fontWeight:"bold",color:"#374151",marginBottom:8}}>🗺️ Konu Bazlı Güçlük Haritası</div>
              {[
                {subj:"turkce",label:"📖 Türkçe",color:"#b91c1c"},
                {subj:"matematik",label:"🔢 Matematik",color:"#1d4ed8"},
                {subj:"fen",label:"🔬 Fen Bilimleri",color:"#16a34a"},
                {subj:"sosyal",label:"🌍 Sosyal Bilgiler",color:"#d97706"},
                {subj:"ingilizce",label:"🇬🇧 İngilizce",color:"#7c3aed"},
              ].map(({subj,label,color})=>{
                const subjKazs=QB.filter(x=>x.subject===subj).map(x=>x.kazanim).filter((v,i,a)=>a.indexOf(v)===i);
                const hasData=subjKazs.some(k=>kazStats[k]);
                if(!hasData)return null;
                return(
                  <div key={subj} style={{marginBottom:10}}>
                    <div style={{fontSize:11,fontWeight:"bold",color,marginBottom:5}}>{label}</div>
                    {subjKazs.filter(k=>kazStats[k]).map(k=>{
                      const ks=kazStats[k];
                      const kpct=Math.round(ks.c/ks.t*100);
                      const kcolor=kpct>=70?"#16a34a":kpct>=40?"#d97706":"#dc2626";
                      return(
                        <div key={k} style={{marginBottom:5}}>
                          <div style={{display:"flex",justifyContent:"space-between",fontSize:10,color:"#6b7280",marginBottom:2}}>
                            <span style={{maxWidth:"75%",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{KAZ_INFO[k]||k}</span>
                            <span style={{color:kcolor,fontWeight:"bold"}}>{ks.c}/{ks.t} · %{kpct}</span>
                          </div>
                          <div style={{height:5,background:"#e5e7eb",borderRadius:3,overflow:"hidden"}}>
                            <div style={{height:"100%",width:`${kpct}%`,background:kcolor,borderRadius:3,transition:"width .4s"}}/>
                          </div>
                        </div>
                      );
                    })}
          ...
          <div style={{display:"flex",gap:8,marginTop:14}}>
            <button style={{...S.btn("#1d4ed8"),marginTop:0,flex:2}} onClick={()=>{setShowStats(false);if(mode)continueMode();else setScreen("intro");}}>
              ▶ Devam Et
            </button>
            <button style={{...S.btn("#ef4444"),marginTop:0,flex:1}} onClick={fullReset}>
              🔄 Sıfırla
            </button>
          </div>
        </div>
  ...
  // ── GEÇMİŞ SORU İNCELEME (salt-okunur) ──────────────────
  if(screen==="review"&&reviewEntry){
    const rq=reviewEntry.q;
    const rsel=reviewEntry.sel;
    const rok=reviewEntry.wasCorrect;
    const rColor=SUBJ_COLOR[rq.subject]||"#b91c1c";
    const isFirst=historyIdx===0;
    const isLast=historyIdx>=history.length-1;
    return(
      <div style={S.app}>
        <div style={{...S.hdr(rColor),display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 14px"}}>
          <div>
            <p style={{...S.hdrT,margin:0,fontSize:15}}>{SUBJ_LABEL[rq.subject]} · Geçmiş Soru</p>
            <p style={{...S.hdrS,margin:0}}>{historyIdx+1}/{history.length} · {rok?"✅ Doğru":"❌ Yanlış"}</p>
          </div>
          <button onClick={()=>{setHistoryIdx(null);setSel(null);setSimplified(false);setScreen("question");}} style={{background:"rgba(255,255,255,.2)",
            border:"none",borderRadius:8,padding:"5px 9px",color:"#fff",fontSize:12,cursor:"pointer",fontFamily:"inherit",fontWeight:"bold"}}>
            ▶ Aktif Soru
          </button>
        </div>
        <div style={S.wrap}>
          <div style={{background:"#fff",borderRadius:13,boxShadow:"0 2px 10px rgba(0,0,0,.08)",
            padding:"11px 14px",marginTop:12,border:`2px solid ${rColor}33`}}>
            <div style={{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap"}}>
              <span style={S.tag(rColor)}>{KAZ_INFO[rq.kazanim]}</span>
              <span style={S.diff(rq.difficulty)}>{DIFF_LABEL[rq.difficulty]}</span>
              <span style={{fontSize:11,marginLeft:"auto",color:rok?"#16a34a":"#dc2626",fontWeight:"bold"}}>
                {rok?"✅ Doğru cevap verdin":"❌ Yanlış cevap verdin"}
              </span>
            </div>
          </div>
          <div style={S.card}>
            {rq.pasaj&&<div style={S.pasaj}>{rq.pasaj}</div>}
            <p style={S.q}>{rq.question}</p>
            {rq.type==="matching"&&(
              <div style={{background:"#f0fdf4",borderRadius:10,padding:"12px",textAlign:"center",color:"#16a34a",fontSize:13}}>
                {rok?"✅ Eşleştirme doğru yapıldı":"❌ Eşleştirme yanlış yapıldı"}
              </div>
            )}
            {rq.type==="punctuation_count"&&(
              <div style={{background:"#f0fdf4",borderRadius:10,padding:"12px",textAlign:"center",color:"#16a34a",fontSize:13}}>
                {rok?"✅ Noktalama doğru sayıldı":"❌ Noktalama yanlış sayıldı"}
              </div>
            )}
            {rq.options&&rq.options.map((opt,i)=>{
              const isCorrect=i===rq.correct;
              const isSelected=i===rsel;
              let bg="#f8fafc",border="2px solid #e2e8f0",fc="#374151";
              if(isCorrect){bg="#f0fdf4";border="2px solid #16a34a";fc="#16a34a";}
              else if(isSelected&&!isCorrect){bg="#fef2f2";border="2px solid #ef4444";fc="#ef4444";}
              return(
                <div key={i} style={{display:"block",width:"100%",textAlign:"left",padding:"11px 13px",
                  marginBottom:7,borderRadius:10,border,background:bg,fontSize:13.5,color:fc,boxSizing:"border-box"}}>
                  {isCorrect&&<span style={{color:"#16a34a",fontWeight:"bold"}}>✓ </span>}
                  {isSelected&&!isCorrect&&<span style={{color:"#ef4444",fontWeight:"bold"}}>✗ </span>}
                  {opt}
                  {isSelected&&isCorrect&&<span style={{fontSize:11,color:"#16a34a",marginLeft:8}}>(senin cevabın ✓)</span>}
                  {isSelected&&!isCorrect&&<span style={{fontSize:11,color:"#ef4444",marginLeft:8}}>(senin cevabın)</span>}
                </div>
              );
            })}
            {!rok&&(
              <div style={S.feedBox}>
                <b style={{fontSize:12,color:"#1d4ed8"}}>📌 Kazanım: {KAZ_INFO[rq.kazanim]}</b>
                <p style={{margin:"5px 0 0",fontSize:13,color:"#1e40af",lineHeight:1.6}}>{rq.wrongFeedback}</p>
              </div>
            )}
          </div>
          <div style={{display:"flex",gap:8,marginTop:4,paddingBottom:20}}>
            <button onClick={()=>!isFirst&&setHistoryIdx(i=>i-1)} style={{...S.btn("#94a3b8"),marginTop:0,flex:1,
              opacity:isFirst?.4:1,cursor:isFirst?"default":"pointer"}}>← Önceki</button>
            <button onClick={()=>!isLast?setHistoryIdx(i=>i+1):(setHistoryIdx(null),setSel(null),setSimplified(false),setScreen("question"))}
              style={{...S.btn(rColor),marginTop:0,flex:1}}>
              {isLast?"▶ Aktif Soru":"İleri →"}
            </button>
          </div>
        </div>
      </div>
  ...
  if(screen==="intro") return(
    <div style={{...S.app,background:"#1a1a2e"}}>
      <div style={S.hdr("#7c3aed")}>
        <p style={S.hdrT}>🎓 Ahmed Hilmi Soru Bankası</p>
        <p style={S.hdrS}>Akıllı Adaptif Sistem · {QB.length} Soru</p>
      </div>
      <div style={S.wrap}>
        <div style={{background:"#16213e",borderRadius:12,padding:"12px 14px",marginTop:12,border:"1px solid #0f3460"}}>
          <div style={{fontSize:11,fontWeight:"bold",color:"#fcd34d",marginBottom:6}}>⚡ SİSTEM NASIL ÇALIŞIR?</div>
          <div style={{fontSize:11,color:"#94a3b8",lineHeight:1.8}}>
            Doğru cevap → Soru zorlaşır 📈 · Yanlış cevap → Konu anlatılır, basite bölünür 🧩
            <br/>Yanlış sorular 3-5 soru sonra tekrar çıkar 🔁 · Süre tutulur ⏱ · Konu haritası 🗺
          </div>
        </div>
        <div style={S.card}>
          <p style={{fontWeight:"bold",fontSize:13,color:"#374151",margin:"0 0 10px",textAlign:"center"}}>
            Hangi derste devam edeceksin?
          </p>
          <div style={{display:"flex",gap:8,flexWrap:"wrap",marginBottom:10}}>
            {[
              {subj:"turkce",color:"#b91c1c",icon:"📖",label:"Türkçe"},
              {subj:"matematik",color:"#1d4ed8",icon:"🔢",label:"Matematik"},
              {subj:"fen",color:"#16a34a",icon:"🔬",label:"Fen Bilimleri"},
              {subj:"sosyal",color:"#d97706",icon:"🌍",label:"Sosyal Bilgiler"},
              {subj:"ingilizce",color:"#7c3aed",icon:"🇬🇧",label:"İngilizce"},
            ].map(({subj,color,icon,label})=>{
              const sp=subjectProgress[subj];
              const total=QB.filter(x=>x.subject===subj).length;
              const done=sp?[...sp.used].length:0;
              const pctS=total&&done?Math.round(done/total*100):0;
              return(
                <button key={subj}
                  style={{...S.subjBtn(color,false),flex:"1 1 45%",position:"relative",paddingBottom:done>0?14:10}}
                  onClick={()=>continueSubject(subj)}>
                  {icon}<br/>
                  <span style={{fontSize:15}}>{label}</span><br/>
                  <span style={{fontSize:10,opacity:.8}}>
                    {done>0?`${done}/${total} · %${pctS}`:`${total} soru`}
                  </span>
                  {done>0&&(
                    <div style={{position:"absolute",bottom:4,left:4,right:4,height:3,
                      background:"rgba(0,0,0,.15)",borderRadius:2,overflow:"hidden"}}>
                      <div style={{height:"100%",width:`${pctS}%`,background:"rgba(255,255,255,.7)",borderRadius:2}}/>
                    </div>
                  )}
                </button>
              );
          ...
          <button style={{...S.subjBtn("#475569",false),width:"100%",marginBottom:8}}
            onClick={()=>continueSubject("karisik")}>
            🎲 Karışık — Tüm dersler ({QB.length} soru)
          </button>
          {Object.keys(subjectProgress).length>0&&(
            <button style={{...S.btn("#1a1a2e"),marginTop:4,fontSize:12}} onClick={()=>setShowStats(true)}>
              📊 İstatistikleri Gör
            </button>
          )}
        </div>
      ...
      <div style={S.wrap}>
        <div style={S.card}>
          <div style={{textAlign:"center"}}>
            ...
            <h2 style={{color:"#1e293b"}}>{mode?`${SUBJ_LABEL[mode]||"Karışık"} Bitti!`:"Tebrikler!"}</h2>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,margin:"10px 0"}}>
            {[{l:"Doğru",v:stats.c,c:"#16a34a"},{l:"Yanlış",v:stats.wrong,c:"#dc2626"},{l:"Soru",v:stats.t,c:"#1d4ed8"}].map(({l,v,c})=>(
              <div key={l} style={{textAlign:"center",background:"#f8fafc",borderRadius:10,padding:"8px 0"}}>
          ...
          <button style={{...S.btn("#1a1a2e"),marginTop:12,fontSize:13}} onClick={goHome}>🏠 Ana Ekrana Dön</button>
        </div>
      </div>
    </div>
  );
  ...
  if(screen==="correct") return(
    <div style={S.app}>
      <div style={{...S.hdr(hdrColor),display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 14px"}}>
        <div>
          <p style={{...S.hdrT,margin:0,fontSize:15}}>{SUBJ_LABEL[q?.subject]}</p>
          <p style={{...S.hdrS,margin:0}}>✓ {stats.c}/{stats.t} · %{pct}{streak>=2&&` · 🔥${streak}`}</p>
        </div>
        <HomeBtn color={hdrColor}/>
      </div>
      <div style={S.wrap}>
        <div style={S.card}>
          ...
          <div style={{display:"flex",gap:8,marginTop:10}}>
            <button style={{...S.btn(hdrColor),marginTop:0,flex:3}} onClick={()=>loadNext()}>➡️ Sonraki Soru</button>
            <button style={{...S.btn("#64748b"),marginTop:0,flex:1,fontSize:12}} onClick={()=>setShowStats(true)}>📊</button>
          </div>
        </div>
      </div>
    </div>
  ...
  if(screen==="wrong") return(
    <div style={S.app}>
      <div style={{...S.hdr(hdrColor),display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 14px"}}>
        <div>
          <p style={{...S.hdrT,margin:0,fontSize:15}}>{SUBJ_LABEL[q?.subject]}</p>
          <p style={{...S.hdrS,margin:0}}>✓ {stats.c}/{stats.t} · %{pct}</p>
        </div>
        <HomeBtn color={hdrColor}/>
      </div>
      <div style={S.wrap}>
        <div style={S.card}>
          ...
          <div style={S.feedBox}>
            <b style={{fontSize:12,color:"#1d4ed8"}}>📌 Kazanım: {KAZ_INFO[q?.kazanim]}</b>
  ...
  if(screen==="question"&&aq) return(
    <div style={S.app}>
      <div style={{...S.hdr(hdrColor),display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 14px"}}>
        <div>
          <p style={{...S.hdrT,margin:0,fontSize:15}}>{SUBJ_LABEL[aq.subject]}</p>
          <p style={{...S.hdrS,margin:0}}>{STUDENT} · ✓{stats.c}/{stats.t} · kalan {remaining}{streak>=2&&` · 🔥${streak}`}{retryQueue.length>0&&` · 🔁${retryQueue.length}`}</p>
        </div>
        <HomeBtn color={hdrColor}/>
      </div>
      <div style={S.wrap}>
        ...
        <div style={{background:"#fff",borderRadius:13,boxShadow:"0 2px 10px rgba(0,0,0,.08)",padding:"11px 14px",marginTop:12,border:`2px solid ${hdrColor}33`}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:4}}>
            <div style={{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap"}}>
              ...
              {isRetry&&<span style={{background:"#fef3c7",color:"#92400e",borderRadius:20,padding:"2px 8px",fontSize:10,fontWeight:"bold",border:"1px solid #fcd34d"}}>🔁 Tekrar</span>}
            </div>
            <button onClick={()=>{setShowJump(s=>!s);setJumpVal("");}}
              ...
              #{solvedInMode+1}/{totalInMode} ↗
            </button>
          </div>
          <div style={{...S.pbar,marginTop:8}}><div style={S.pbarFill(Math.round(solvedInMode/totalInMode*100),pbarColor)}/></div>
        </div>
        {showJump&&(
          <div style={{background:"#fff",borderRadius:12,padding:"12px 14px",marginTop:8,
            boxShadow:"0 2px 10px rgba(0,0,0,.1)",border:"2px solid "+hdrColor}}>
            <div style={{fontSize:12,fontWeight:"bold",color:"#374151",marginBottom:8}}>
              Kaçıncı soruya gitmek istiyorsun? (1–{QB.filter(x=>mode==="karisik"||x.subject===mode).length})
            </div>
            <div style={{display:"flex",gap:8}}>
              <input
                type="number" min="1"
                max={QB.filter(x=>mode==="karisik"||x.subject===mode).length}
                value={jumpVal}
                onChange={e=>setJumpVal(e.target.value)}
                onKeyDown={e=>e.key==="Enter"&&jumpToQuestion(jumpVal)}
                placeholder="Soru no..."
                style={{flex:1,padding:"8px 10px",borderRadius:8,border:"1px solid #d1d5db",
                fontSize:14,fontFamily:"inherit",outline:"none"}}
              />
              <button onClick={()=>jumpToQuestion(jumpVal)}
                style={{...S.btn(hdrColor),marginTop:0,padding:"8px 16px",width:"auto"}}>
                Git →
              </button>
              <button onClick={()=>setShowJump(false)}
                style={{...S.btn("#94a3b8"),marginTop:0,padding:"8px 12px",width:"auto"}}>
                ✕
              </button>
            </div>
          </div>
        ...
        {/* Sıfırdan başla — sadece cevap verilmemişse göster */}
        {sel===null&&mode&&mode!=="karisik"&&(
          <div style={{textAlign:"center",paddingBottom:16,marginTop:4}}>
            <button onClick={()=>startFresh(mode)}
              style={{background:"none",border:"none",color:"#94a3b8",fontSize:11,cursor:"pointer",
              textDecoration:"underline",fontFamily:"inherit",padding:"4px 8px"}}>
              🔄 Bu dersi sıfırdan başla
            </button>
          </div>
        )}
      </div>
